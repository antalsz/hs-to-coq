    ...
    let fix realsize t'
              := match t' with
                 ...
                 | Bin sz _ l r =>
                     ...
                     | pair (Some n) (Some m) =>
                         if ((n GHC.Num.+ m) GHC.Num.+ GHC.Num.fromInteger 1) GHC.Base.== sz : bool
                         then Some sz
                         else None
                     | _ => None
                     end
...
Definition balanced {a} : Set_ a -> bool :=
  fix balanced t
        := match t with
           | Tip => true
           | Bin _ _ l r =>
               andb (orb ((size l GHC.Num.+ size r) GHC.Base.<= GHC.Num.fromInteger 1) (andb
                         (size l GHC.Base.<= (delta GHC.Num.* size r)) (size r GHC.Base.<= (delta
                         GHC.Num.* size l)))) (andb (balanced l) (balanced r))
           end.
...
Definition balanceR {a} : a -> Set_ a -> Set_ a -> Set_ a :=
  fun x l r =>
    ...
    | Tip =>
        ...
        | Bin _ rx Tip (Bin _ _ _ _ as rr) =>
            Bin (GHC.Num.fromInteger 3) rx (Bin (GHC.Num.fromInteger 1) x Tip Tip) rr
        | Bin _ rx (Bin _ rlx _ _) Tip =>
            Bin (GHC.Num.fromInteger 3) rlx (Bin (GHC.Num.fromInteger 1) x Tip Tip) (Bin
                                                                                    (GHC.Num.fromInteger 1) rx Tip Tip)
        | Bin rs rx (Bin rls rlx rll rlr as rl) (Bin rrs _ _ _ as rr) =>
            if rls GHC.Base.< (ratio GHC.Num.* rrs) : bool
            then Bin (GHC.Num.fromInteger 1 GHC.Num.+ rs) rx (Bin (GHC.Num.fromInteger 1
                                                                  GHC.Num.+ rls) x Tip rl) rr
            else Bin (GHC.Num.fromInteger 1 GHC.Num.+ rs) rlx (Bin (GHC.Num.fromInteger 1
                                                                   GHC.Num.+ size rll) x Tip rll) (Bin
                                                                                                  ((GHC.Num.fromInteger
                                                                                                  1 GHC.Num.+ rrs)
                                                                                                  GHC.Num.+ size rlr) rx
                                                                                                  rlr rr)
        ...
        | Bin rs rx rl rr =>
            ...
            then let scrut_10__ := pair rl rr in
                 ...
                 | pair (Bin rls rlx rll rlr) (Bin rrs _ _ _) =>
                     if rls GHC.Base.< (ratio GHC.Num.* rrs) : bool
                     then Bin ((GHC.Num.fromInteger 1 GHC.Num.+ ls) GHC.Num.+ rs) rx (Bin
                                                                                     ((GHC.Num.fromInteger 1 GHC.Num.+
                                                                                     ls) GHC.Num.+ rls) x l rl) rr
                     else Bin ((GHC.Num.fromInteger 1 GHC.Num.+ ls) GHC.Num.+ rs) rlx (Bin
                                                                                      ((GHC.Num.fromInteger 1 GHC.Num.+
                                                                                      ls) GHC.Num.+ size rll) x l rll)
                          (Bin ((GHC.Num.fromInteger 1 GHC.Num.+ rrs) GHC.Num.+ size rlr) rx rlr rr)
                 | _ =>
  ...
  fun x l r =>
    ...
    | Tip =>
        ...
        | Bin _ lx Tip (Bin _ lrx _ _) =>
            Bin (GHC.Num.fromInteger 3) lrx (Bin (GHC.Num.fromInteger 1) lx Tip Tip) (Bin
                                                                                     (GHC.Num.fromInteger 1) x Tip Tip)
        | Bin _ lx (Bin _ _ _ _ as ll) Tip =>
            Bin (GHC.Num.fromInteger 3) lx ll (Bin (GHC.Num.fromInteger 1) x Tip Tip)
        | Bin ls lx (Bin lls _ _ _ as ll) (Bin lrs lrx lrl lrr as lr) =>
            if lrs GHC.Base.< (ratio GHC.Num.* lls) : bool
            then Bin (GHC.Num.fromInteger 1 GHC.Num.+ ls) lx ll (Bin (GHC.Num.fromInteger 1
                                                                     GHC.Num.+ lrs) x lr Tip)
            else Bin (GHC.Num.fromInteger 1 GHC.Num.+ ls) lrx (Bin ((GHC.Num.fromInteger 1
                                                                   GHC.Num.+ lls) GHC.Num.+ size lrl) lx ll lrl) (Bin
                                                                                                                 (GHC.Num.fromInteger
                                                                                                                 1
                                                                                                                 GHC.Num.+
                                                                                                                 size
        ...
        | Bin ls lx ll lr =>
            ...
            then let scrut_10__ := pair ll lr in
                 ...
                 | pair (Bin lls _ _ _) (Bin lrs lrx lrl lrr) =>
                     if lrs GHC.Base.< (ratio GHC.Num.* lls) : bool
                     then Bin ((GHC.Num.fromInteger 1 GHC.Num.+ ls) GHC.Num.+ rs) lx ll (Bin
                                                                                        ((GHC.Num.fromInteger 1
                                                                                        GHC.Num.+ rs) GHC.Num.+ lrs) x
                                                                                        lr r)
                     else Bin ((GHC.Num.fromInteger 1 GHC.Num.+ ls) GHC.Num.+ rs) lrx (Bin
                                                                                      ((GHC.Num.fromInteger 1 GHC.Num.+
                                                                                      lls) GHC.Num.+ size lrl) lx ll
                                                                                      lrl) (Bin ((GHC.Num.fromInteger 1
                                                                                                GHC.Num.+ rs) GHC.Num.+
                                                                                                size lrr) x lrr r)
                 | _ =>
                     let 'pair _ _ := scrut_10__ in
        ...
        let create :=
          unsafeFix (fun create arg_1__ arg_2__ =>
                      ...
                      | s , (cons x xs' as xs) =>
                          ...
                          then (pair (Bin (GHC.Num.fromInteger 1) x Tip Tip) xs')
          ...
          unsafeFix (fun create arg_8__ arg_9__ =>
                      ...
                      | s , (cons x xss as xs) =>
                          ...
                          then if not_ordered x xss : bool
                               then pair (pair (Bin (GHC.Num.fromInteger 1) x Tip Tip) nil) xss
                               else pair (pair (Bin (GHC.Num.fromInteger 1) x Tip Tip) xss) nil
                          else match create (Data.Bits.shiftR s (GHC.Num.fromInteger 1)) xs with
          ...
          unsafeFix (fun go arg_22__ arg_23__ arg_24__ =>
                      ...
                      | s , l , (cons x xss as xs) =>
                          ...
                          then fromList' l xs
                               ...
                               | pair (pair r ys) nil =>
                                   go (Data.Bits.shiftL s (GHC.Num.fromInteger 1)) (link x l r) ys
                              ...
                              | i , _ =>
                                  ...
                                  then Tip
                                       ...
                                       | i , Bin _ x l r =>
                                           ...
                                           match GHC.Base.compare i sizeL with
                                           | Lt => go i l
                                           | Gt => link x l (go ((i GHC.Num.- sizeL) GHC.Num.- GHC.Num.fromInteger 1) r)
                                           | Eq => l
                                           end
                                       end
                              end in
