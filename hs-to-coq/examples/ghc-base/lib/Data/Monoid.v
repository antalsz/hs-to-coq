...
(* Translating `instance forall `{GHC.BaseGen.Alternative f}, GHC.BaseGen.Monoid
   (Alt f a)' failed: OOPS! Cannot construct types for this class def: Nothing
   unsupported *)
...
Instance instance_forall___GHC_BaseGen_Alternative_f___GHC_BaseGen_Monoid__Alt_f_a_
  : !forall `{GHC.BaseGen.Alternative f}, GHC.BaseGen.Monoid (Alt f a) := {}.
Proof.
Admitted.

Instance instance_forall___GHC_BaseGen_Monoid_a___GHC_BaseGen_Monoid__Dual_a_
...
Instance instance_forall___GHC_Num_Num_a___GHC_BaseGen_Monoid__Product_a_
...
Instance instance_forall___GHC_Num_Num_a___GHC_BaseGen_Monoid__Sum_a_
