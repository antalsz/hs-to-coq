...
Inductive ConCont : Type
  := CC : list CoreSyn.CoreExpr -> Core.Coercion -> ConCont.
...
Axiom exprIsLambda_maybe : CoreSyn.InScopeEnv ->
                           CoreSyn.CoreExpr ->
                           option (Core.Var * CoreSyn.CoreExpr * list (CoreSyn.Tickish Var.Id))%type.

Axiom pushCoercionIntoLambda : VarEnv.InScopeSet ->
                               Core.Var ->
                               CoreSyn.CoreExpr -> Core.Coercion -> option (Core.Var * CoreSyn.CoreExpr)%type.
...
Axiom exprIsConApp_maybe : CoreSyn.InScopeEnv ->
                           CoreSyn.CoreExpr ->
                           option (DataCon.DataCon * list Core.Type_ * list CoreSyn.CoreExpr)%type.
...
Axiom extendSubstList : Subst ->
                        list (Core.Var * CoreSyn.CoreArg)%type -> Subst.
...
Axiom dealWithCoercion : Core.Coercion ->
                         DataCon.DataCon ->
