...
Definition execute {p} {t} `{(Program.RiscvProgram p t)}
  ...
  fun arg_0__ =>
    ...
    | Decode.Beq rs1 rs2 sbimm12 =>
        Program.getRegister rs1 >>=
        (fun x =>
           Program.getRegister rs2 GHC.Base.>>=
           (fun y =>
              Program.getPC GHC.Base.>>=
              (fun pc =>
    ...
    | Decode.Lb rd rs1 oimm12 =>
        ...
        (fun a =>
           VirtualMemory.translate VirtualMemory.Load 1 (a GHC.Num.+
                                                         Utility.fromImm oimm12) GHC.Base.>>=
           (fun addr =>
              Program.loadByte addr GHC.Base.>>=
    ...
    | Decode.Lh rd rs1 oimm12 =>
        ...
        (fun a =>
           VirtualMemory.translate VirtualMemory.Load 2 (a GHC.Num.+
                                                         Utility.fromImm oimm12) GHC.Base.>>=
           (fun addr =>
              Program.loadHalf addr GHC.Base.>>=
    ...
    | Decode.Lw rd rs1 oimm12 =>
        ...
        (fun a =>
           VirtualMemory.translate VirtualMemory.Load 4 (a GHC.Num.+
                                                         Utility.fromImm oimm12) GHC.Base.>>=
           (fun addr =>
              Program.loadWord addr GHC.Base.>>=
    ...
    | Decode.Sb rs1 rs2 simm12 =>
        ...
        (fun a =>
           VirtualMemory.translate VirtualMemory.Store 1 (a GHC.Num.+
                                                          Utility.fromImm simm12) GHC.Base.>>=
           (fun addr =>
              Program.getRegister rs2 GHC.Base.>>=
    ...
    | Decode.Add rd rs1 rs2 =>
        ...
        (fun x =>
           Program.getRegister rs2 GHC.Base.>>=
           (fun y => Program.setRegister rd (x GHC.Num.+ y)))
...
(* Unbound variables:
     ...
     GHC.Base.op_zgzgze__ GHC.Base.op_zl__ GHC.Base.op_zsze__ GHC.Base.when
     GHC.Err.error GHC.Num.op_zm__ GHC.Num.op_zp__ GHC.Real.mod_ Program.RiscvProgram
     Program.getPC Program.getRegister Program.loadByte Program.loadHalf
     Program.loadWord Program.raiseException Program.setPC Program.setRegister
     Program.storeByte Program.storeHalf Program.storeWord Utility.fromImm
     ...
     VirtualMemory.Load VirtualMemory.Store VirtualMemory.translate
*)
