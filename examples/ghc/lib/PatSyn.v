...
Inductive PatSyn : Type := MkPatSyn : Name.Name -> Unique.Unique -> list
                                      TyCoRep.Type_ -> BasicTypes.Arity -> bool -> list FieldLabel.FieldLabel -> list
                                      Var.TyVar -> list TyCoRep.TyBinder -> TyCoRep.ThetaType -> list
                                      Var.TyVar -> list
                                      TyCoRep.TyBinder -> TyCoRep.ThetaType -> TyCoRep.Type_ -> (Var.Id *
                                      bool)%type -> option (Var.Id * bool)%type -> PatSyn.
