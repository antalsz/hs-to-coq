...
Local Definition instance_Traversable__Data_Functor_Const_Const_m__traverse {inst_m}
    : forall {f} {a} {b},
        forall `{GHC.Base.Applicative f},
...
Local Definition instance_Traversable__Data_Functor_Const_Const_m__sequenceA {inst_m}
    : forall {f} {a},
        forall `{GHC.Base.Applicative f},
          (Data.Functor.Const.Const inst_m) (f a) -> f ((Data.Functor.Const.Const inst_m)
                                                       a) :=
  fun {f} {a} `{GHC.Base.Applicative f} =>
    instance_Traversable__Data_Functor_Const_Const_m__traverse GHC.Base.id.

Local Definition instance_Traversable__Data_Functor_Const_Const_m__sequence {inst_m}
    : forall {m} {a},
        forall `{GHC.Base.Monad m},
          (Data.Functor.Const.Const inst_m) (m a) -> m ((Data.Functor.Const.Const inst_m)
                                                       a) :=
  fun {m} {a} `{GHC.Base.Monad m} =>
    instance_Traversable__Data_Functor_Const_Const_m__sequenceA.

Local Definition instance_Traversable__Data_Functor_Const_Const_m__mapM {inst_m}
    : forall {m} {a} {b},
        forall `{GHC.Base.Monad m},
          (a -> m b) -> (Data.Functor.Const.Const inst_m) a -> m
          ((Data.Functor.Const.Const inst_m) b) :=
  fun {m} {a} {b} `{GHC.Base.Monad m} =>
    instance_Traversable__Data_Functor_Const_Const_m__traverse.

Program Instance instance_Traversable__Data_Functor_Const_Const_m_ {m}
  : Traversable (Data.Functor.Const.Const m) := fun _ k =>
    k {|mapM__ := fun {m} {a} {b} `{GHC.Base.Monad m} =>
        instance_Traversable__Data_Functor_Const_Const_m__mapM ;
      sequence__ := fun {m} {a} `{GHC.Base.Monad m} =>
        instance_Traversable__Data_Functor_Const_Const_m__sequence ;
      sequenceA__ := fun {f} {a} `{GHC.Base.Applicative f} =>
        instance_Traversable__Data_Functor_Const_Const_m__sequenceA ;
      traverse__ := fun {f} {a} {b} `{GHC.Base.Applicative f} =>
        instance_Traversable__Data_Functor_Const_Const_m__traverse |}.

Local Definition instance_Traversable_Data_Monoid_Dual_traverse : forall {f}
                                                                         {a}
                                                                         {b},
                                                                    forall `{GHC.Base.Applicative f},
                                                                      (a -> f b) -> Data.Monoid.Dual a -> f
                                                                      (Data.Monoid.Dual b) :=
  fun {f} {a} {b} `{GHC.Base.Applicative f} =>
...
Local Definition instance_Traversable_Data_Monoid_Dual_sequenceA : forall {f}
                                                                          {a},
                                                                     forall `{GHC.Base.Applicative f},
                                                                       Data.Monoid.Dual (f a) -> f (Data.Monoid.Dual
                                                                                                   a) :=
  fun {f} {a} `{GHC.Base.Applicative f} =>
    instance_Traversable_Data_Monoid_Dual_traverse GHC.Base.id.

Local Definition instance_Traversable_Data_Monoid_Dual_sequence : forall {m}
                                                                         {a},
                                                                    forall `{GHC.Base.Monad m},
                                                                      Data.Monoid.Dual (m a) -> m (Data.Monoid.Dual
                                                                                                  a) :=
  fun {m} {a} `{GHC.Base.Monad m} =>
    instance_Traversable_Data_Monoid_Dual_sequenceA.

Local Definition instance_Traversable_Data_Monoid_Dual_mapM : forall {m}
                                                                     {a}
                                                                     {b},
                                                                forall `{GHC.Base.Monad m},
                                                                  (a -> m b) -> Data.Monoid.Dual a -> m
                                                                  (Data.Monoid.Dual b) :=
  fun {m} {a} {b} `{GHC.Base.Monad m} =>
    instance_Traversable_Data_Monoid_Dual_traverse.

Program Instance instance_Traversable_Data_Monoid_Dual : Traversable
                                                         Data.Monoid.Dual := fun _ k =>
    k {|mapM__ := fun {m} {a} {b} `{GHC.Base.Monad m} =>
        instance_Traversable_Data_Monoid_Dual_mapM ;
      sequence__ := fun {m} {a} `{GHC.Base.Monad m} =>
        instance_Traversable_Data_Monoid_Dual_sequence ;
      sequenceA__ := fun {f} {a} `{GHC.Base.Applicative f} =>
        instance_Traversable_Data_Monoid_Dual_sequenceA ;
      traverse__ := fun {f} {a} {b} `{GHC.Base.Applicative f} =>
        instance_Traversable_Data_Monoid_Dual_traverse |}.

Local Definition instance_Traversable_Data_Monoid_Sum_traverse : forall {f}
                                                                        {a}
                                                                        {b},
                                                                   forall `{GHC.Base.Applicative f},
                                                                     (a -> f b) -> Data.Monoid.Sum a -> f
                                                                     (Data.Monoid.Sum b) :=
  fun {f} {a} {b} `{GHC.Base.Applicative f} =>
...
Local Definition instance_Traversable_Data_Monoid_Sum_sequenceA : forall {f}
                                                                         {a},
                                                                    forall `{GHC.Base.Applicative f},
                                                                      Data.Monoid.Sum (f a) -> f (Data.Monoid.Sum a) :=
  fun {f} {a} `{GHC.Base.Applicative f} =>
    instance_Traversable_Data_Monoid_Sum_traverse GHC.Base.id.

Local Definition instance_Traversable_Data_Monoid_Sum_sequence : forall {m} {a},
                                                                   forall `{GHC.Base.Monad m},
                                                                     Data.Monoid.Sum (m a) -> m (Data.Monoid.Sum a) :=
  fun {m} {a} `{GHC.Base.Monad m} =>
    instance_Traversable_Data_Monoid_Sum_sequenceA.

Local Definition instance_Traversable_Data_Monoid_Sum_mapM : forall {m} {a} {b},
                                                               forall `{GHC.Base.Monad m},
                                                                 (a -> m b) -> Data.Monoid.Sum a -> m (Data.Monoid.Sum
                                                                                                      b) :=
  fun {m} {a} {b} `{GHC.Base.Monad m} =>
    instance_Traversable_Data_Monoid_Sum_traverse.

Program Instance instance_Traversable_Data_Monoid_Sum : Traversable
                                                        Data.Monoid.Sum := fun _ k =>
    k {|mapM__ := fun {m} {a} {b} `{GHC.Base.Monad m} =>
        instance_Traversable_Data_Monoid_Sum_mapM ;
      sequence__ := fun {m} {a} `{GHC.Base.Monad m} =>
        instance_Traversable_Data_Monoid_Sum_sequence ;
      sequenceA__ := fun {f} {a} `{GHC.Base.Applicative f} =>
        instance_Traversable_Data_Monoid_Sum_sequenceA ;
      traverse__ := fun {f} {a} {b} `{GHC.Base.Applicative f} =>
        instance_Traversable_Data_Monoid_Sum_traverse |}.

Local Definition instance_Traversable_Data_Monoid_Product_traverse : forall {f}
                                                                            {a}
                                                                            {b},
                                                                       forall `{GHC.Base.Applicative f},
                                                                         (a -> f b) -> Data.Monoid.Product a -> f
                                                                         (Data.Monoid.Product b) :=
  fun {f} {a} {b} `{GHC.Base.Applicative f} =>
...
Local Definition instance_Traversable_Data_Monoid_Product_sequenceA : forall {f}
                                                                             {a},
                                                                        forall `{GHC.Base.Applicative f},
                                                                          Data.Monoid.Product (f a) -> f
                                                                          (Data.Monoid.Product a) :=
  fun {f} {a} `{GHC.Base.Applicative f} =>
    instance_Traversable_Data_Monoid_Product_traverse GHC.Base.id.

Local Definition instance_Traversable_Data_Monoid_Product_sequence : forall {m}
                                                                            {a},
                                                                       forall `{GHC.Base.Monad m},
                                                                         Data.Monoid.Product (m a) -> m
                                                                         (Data.Monoid.Product a) :=
  fun {m} {a} `{GHC.Base.Monad m} =>
    instance_Traversable_Data_Monoid_Product_sequenceA.

Local Definition instance_Traversable_Data_Monoid_Product_mapM : forall {m}
                                                                        {a}
                                                                        {b},
                                                                   forall `{GHC.Base.Monad m},
                                                                     (a -> m b) -> Data.Monoid.Product a -> m
                                                                     (Data.Monoid.Product b) :=
  fun {m} {a} {b} `{GHC.Base.Monad m} =>
    instance_Traversable_Data_Monoid_Product_traverse.

Program Instance instance_Traversable_Data_Monoid_Product : Traversable
                                                            Data.Monoid.Product := fun _ k =>
    k {|mapM__ := fun {m} {a} {b} `{GHC.Base.Monad m} =>
        instance_Traversable_Data_Monoid_Product_mapM ;
      sequence__ := fun {m} {a} `{GHC.Base.Monad m} =>
        instance_Traversable_Data_Monoid_Product_sequence ;
      sequenceA__ := fun {f} {a} `{GHC.Base.Applicative f} =>
        instance_Traversable_Data_Monoid_Product_sequenceA ;
      traverse__ := fun {f} {a} {b} `{GHC.Base.Applicative f} =>
        instance_Traversable_Data_Monoid_Product_traverse |}.
...
Local Definition instance_GHC_Base_Functor__StateL_s__fmap {inst_s} : forall {a}
                                                                             {b},
                                                                        (a -> b) -> (StateL inst_s) a -> (StateL inst_s)
                                                                        b :=
  fun {a} {b} =>
...
Local Definition instance_GHC_Base_Functor__StateL_s__op_zlzd__ {inst_s}
    : forall {a} {b}, a -> (StateL inst_s) b -> (StateL inst_s) a :=
  fun {a} {b} =>
    fun x => instance_GHC_Base_Functor__StateL_s__fmap (GHC.Base.const x).

Program Instance instance_GHC_Base_Functor__StateL_s_ {s} : GHC.Base.Functor
                                                            (StateL s) := fun _ k =>
    k {|GHC.Base.op_zlzd____ := fun {a} {b} =>
        instance_GHC_Base_Functor__StateL_s__op_zlzd__ ;
      GHC.Base.fmap__ := fun {a} {b} => instance_GHC_Base_Functor__StateL_s__fmap |}.

Local Definition instance_GHC_Base_Applicative__StateL_s__op_zlztzg__ {inst_s}
    : forall {a} {b},
...
Local Definition instance_GHC_Base_Applicative__StateL_s__op_ztzg__ {inst_s}
    : forall {a} {b}, (StateL inst_s) a -> (StateL inst_s) b -> (StateL inst_s) b :=
  fun {a} {b} =>
    fun x y =>
      instance_GHC_Base_Applicative__StateL_s__op_zlztzg__ (GHC.Base.fmap
                                                           (GHC.Base.const GHC.Base.id) x) y.

Local Definition instance_GHC_Base_Applicative__StateL_s__pure {inst_s}
    : forall {a}, a -> (StateL inst_s) a :=
  fun {a} => fun x => Mk_StateL (fun s => pair s x).

Program Instance instance_GHC_Base_Applicative__StateL_s_ {s}
  : GHC.Base.Applicative (StateL s) := fun _ k =>
    k {|GHC.Base.op_ztzg____ := fun {a} {b} =>
        instance_GHC_Base_Applicative__StateL_s__op_ztzg__ ;
      GHC.Base.op_zlztzg____ := fun {a} {b} =>
        instance_GHC_Base_Applicative__StateL_s__op_zlztzg__ ;
      GHC.Base.pure__ := fun {a} => instance_GHC_Base_Applicative__StateL_s__pure |}.

Local Definition instance_GHC_Base_Functor__StateR_s__fmap {inst_s} : forall {a}
                                                                             {b},
                                                                        (a -> b) -> (StateR inst_s) a -> (StateR inst_s)
                                                                        b :=
  fun {a} {b} =>
...
Local Definition instance_GHC_Base_Functor__StateR_s__op_zlzd__ {inst_s}
    : forall {a} {b}, a -> (StateR inst_s) b -> (StateR inst_s) a :=
  fun {a} {b} =>
    fun x => instance_GHC_Base_Functor__StateR_s__fmap (GHC.Base.const x).

Program Instance instance_GHC_Base_Functor__StateR_s_ {s} : GHC.Base.Functor
                                                            (StateR s) := fun _ k =>
    k {|GHC.Base.op_zlzd____ := fun {a} {b} =>
        instance_GHC_Base_Functor__StateR_s__op_zlzd__ ;
      GHC.Base.fmap__ := fun {a} {b} => instance_GHC_Base_Functor__StateR_s__fmap |}.

Local Definition instance_GHC_Base_Applicative__StateR_s__op_zlztzg__ {inst_s}
    : forall {a} {b},
...
Local Definition instance_GHC_Base_Applicative__StateR_s__op_ztzg__ {inst_s}
    : forall {a} {b}, (StateR inst_s) a -> (StateR inst_s) b -> (StateR inst_s) b :=
  fun {a} {b} =>
    fun x y =>
      instance_GHC_Base_Applicative__StateR_s__op_zlztzg__ (GHC.Base.fmap
                                                           (GHC.Base.const GHC.Base.id) x) y.

Local Definition instance_GHC_Base_Applicative__StateR_s__pure {inst_s}
    : forall {a}, a -> (StateR inst_s) a :=
  fun {a} => fun x => Mk_StateR (fun s => pair s x).

Program Instance instance_GHC_Base_Applicative__StateR_s_ {s}
  : GHC.Base.Applicative (StateR s) := fun _ k =>
    k {|GHC.Base.op_ztzg____ := fun {a} {b} =>
        instance_GHC_Base_Applicative__StateR_s__op_ztzg__ ;
      GHC.Base.op_zlztzg____ := fun {a} {b} =>
        instance_GHC_Base_Applicative__StateR_s__op_zlztzg__ ;
      GHC.Base.pure__ := fun {a} => instance_GHC_Base_Applicative__StateR_s__pure |}.
...
Definition fmapDefault {t} {a} {b} `{Traversable t} : (a -> b) -> t a -> t b :=
  fun f =>
    Coq.Program.Basics.compose getId (traverse (Coq.Program.Basics.compose Mk_Id
                                                                           f)).
...
Definition mapAccumL {t} {a} {b} {c} `{Traversable t} : (a -> b -> a *
                                                        c) -> a -> t b -> a * t c :=
  fun f s t =>
    runStateL (traverse (Coq.Program.Basics.compose Mk_StateL (GHC.Base.flip f)) t)
    s.

Definition mapAccumR {t} {a} {b} {c} `{Traversable t} : (a -> b -> a *
                                                        c) -> a -> t b -> a * t c :=
  fun f s t =>
    runStateR (traverse (Coq.Program.Basics.compose Mk_StateR (GHC.Base.flip f)) t)
    s.

(* Unbound variables:
     * Coq.Program.Basics.compose Data.Either.Either Data.Either.Mk_Left
     Data.Either.Mk_Right Data.Foldable.Foldable Data.Functor.Const.Const
     Data.Functor.Const.Mk_Const Data.Functor.op_zlzdzg__ Data.Monoid.Dual
     ...
     GHC.Base.flip GHC.Base.fmap GHC.Base.foldr GHC.Base.id GHC.Base.op_zd__
     GHC.Base.op_zlztzg__ GHC.Base.pure Some cons list nil option pair
*)
