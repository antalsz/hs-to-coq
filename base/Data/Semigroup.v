...
=======
Local Definition Semigroup__unit_sconcat
   : Data.List.NonEmpty.NonEmpty unit -> unit :=
  fun arg_0__ => tt.
...
>>>>>>> dc245e2a07d60343ed30485d24ec72ba03af89dd
Admit Obligations.
...
Local Definition Semigroup__list_sconcat {inst_a}
   : Data.List.NonEmpty.NonEmpty (list inst_a) -> list inst_a :=
  fun arg_0__ =>
    let 'Data.List.NonEmpty.NEcons a as_ := arg_0__ in
    let fix go arg_1__ arg_2__
              := match arg_1__, arg_2__ with
...
Local Definition Semigroup__Either_sconcat {inst_a} {inst_b}
   : Data.List.NonEmpty.NonEmpty (Data.Either.Either inst_a inst_b) ->
     (Data.Either.Either inst_a inst_b) :=
  fun arg_0__ =>
    let 'Data.List.NonEmpty.NEcons a as_ := arg_0__ in
    let fix go arg_1__ arg_2__
...
Local Definition Semigroup__op_zt____op_zt___sconcat {inst_a} {inst_b} {inst_c}
  `{Semigroup inst_a} `{Semigroup inst_b} `{Semigroup inst_c}
   : Data.List.NonEmpty.NonEmpty (inst_a * inst_b * inst_c)%type ->
     (inst_a * inst_b * inst_c)%type :=
  fun arg_0__ =>
    let 'Data.List.NonEmpty.NEcons a as_ := arg_0__ in
    let fix go arg_1__ arg_2__
...
Local Definition Semigroup__op_zt____op_zt____op_zt____23_sconcat {inst_a}
  {inst_b} {inst_c} {inst_d} `{Semigroup inst_a} `{Semigroup inst_b} `{Semigroup
  inst_c} `{Semigroup inst_d}
   : Data.List.NonEmpty.NonEmpty (inst_a * inst_b * inst_c * inst_d)%type ->
     (inst_a * inst_b * inst_c * inst_d)%type :=
  fun arg_0__ =>
    let 'Data.List.NonEmpty.NEcons a as_ := arg_0__ in
    let fix go arg_1__ arg_2__
...
Local Definition Semigroup__comparison_sconcat
   : Data.List.NonEmpty.NonEmpty comparison -> comparison :=
  fun arg_0__ =>
    let 'Data.List.NonEmpty.NEcons a as_ := arg_0__ in
    let fix go arg_1__ arg_2__
              := match arg_1__, arg_2__ with
...
Local Definition Semigroup__Dual_sconcat {inst_a} `{Semigroup inst_a}
   : Data.List.NonEmpty.NonEmpty (Data.Monoid.Dual inst_a) ->
     (Data.Monoid.Dual inst_a) :=
  fun arg_0__ =>
    let 'Data.List.NonEmpty.NEcons a as_ := arg_0__ in
    let fix go arg_1__ arg_2__
...
=======
Local Definition Semigroup__Endo_sconcat {inst_a}
   : Data.List.NonEmpty.NonEmpty (Data.Monoid.Endo inst_a) ->
     (Data.Monoid.Endo inst_a) :=
  fun arg_0__ =>
    let 'Data.List.NonEmpty.NEcons a as_ := arg_0__ in
    let fix go arg_1__ arg_2__
              := match arg_1__, arg_2__ with
...
=======
Local Definition Semigroup__All_sconcat
   : Data.List.NonEmpty.NonEmpty Data.Monoid.All -> Data.Monoid.All :=
  fun arg_0__ =>
    let 'Data.List.NonEmpty.NEcons a as_ := arg_0__ in
    let fix go arg_1__ arg_2__
              := match arg_1__, arg_2__ with
...
=======
Local Definition Semigroup__Any_sconcat
   : Data.List.NonEmpty.NonEmpty Data.Monoid.Any -> Data.Monoid.Any :=
  fun arg_0__ =>
    let 'Data.List.NonEmpty.NEcons a as_ := arg_0__ in
    let fix go arg_1__ arg_2__
              := match arg_1__, arg_2__ with
...
Local Definition Semigroup__Sum_sconcat {inst_a} `{GHC.Num.Num inst_a}
   : Data.List.NonEmpty.NonEmpty (Data.Monoid.Sum inst_a) ->
     (Data.Monoid.Sum inst_a) :=
  fun arg_0__ =>
    let 'Data.List.NonEmpty.NEcons a as_ := arg_0__ in
    let fix go arg_1__ arg_2__
              := match arg_1__, arg_2__ with
...
Local Definition Semigroup__Product_sconcat {inst_a} `{GHC.Num.Num inst_a}
   : Data.List.NonEmpty.NonEmpty (Data.Monoid.Product inst_a) ->
     (Data.Monoid.Product inst_a) :=
  fun arg_0__ =>
    let 'Data.List.NonEmpty.NEcons a as_ := arg_0__ in
    let fix go arg_1__ arg_2__
...
Local Definition Semigroup__Const_sconcat {inst_a} {inst_b} `{Semigroup inst_a}
   : Data.List.NonEmpty.NonEmpty (Data.Functor.Const.Const inst_a inst_b) ->
     (Data.Functor.Const.Const inst_a inst_b) :=
  fun arg_0__ =>
    let 'Data.List.NonEmpty.NEcons a as_ := arg_0__ in
    let fix go arg_1__ arg_2__
...
=======
Local Definition Semigroup__Void_sconcat
   : Data.List.NonEmpty.NonEmpty Data.Void.Void -> Data.Void.Void :=
  fun arg_0__ =>
    let 'Data.List.NonEmpty.NEcons a as_ := arg_0__ in
    let fix go arg_1__ arg_2__
              := match arg_1__, arg_2__ with
...
Local Definition Semigroup__NonEmpty_sconcat {inst_a}
   : Data.List.NonEmpty.NonEmpty (Data.List.NonEmpty.NonEmpty inst_a) ->
     (Data.List.NonEmpty.NonEmpty inst_a) :=
  fun arg_0__ =>
    let 'Data.List.NonEmpty.NEcons a as_ := arg_0__ in
    let fix go arg_1__ arg_2__
...
Local Definition Semigroup__WrappedMonoid_sconcat {inst_m} `{GHC.Base.Monoid
  inst_m}
   : Data.List.NonEmpty.NonEmpty (WrappedMonoid inst_m) ->
...
=======
Local Definition Semigroup__Proxy_sconcat {inst_s}
   : Data.List.NonEmpty.NonEmpty (Data.Proxy.Proxy inst_s) ->
     (Data.Proxy.Proxy inst_s) :=
