...
Inductive WhenMatched f k x y z : Type := Mk_WhenMatched : (k -> x -> y -> f
                                                           (option z)) -> WhenMatched f k x y z.

Inductive TraceResult a : Type := Mk_TraceResult : (option
                                                   a) -> Utils.Containers.Internal.BitQueue.BitQueue -> TraceResult a.

Inductive StrictTriple a b c : Type := Mk_StrictTriple
                                      : a -> b -> c -> StrictTriple a b c.
...
Inductive WhenMissing f k x y : Type := Mk_WhenMissing : (Map k x -> f (Map k
                                                                       y)) -> (k -> x -> f (option y)) -> WhenMissing f
                                                                                                                      k
                                                                                                                      x
                                                                                                                      y.
...
Inductive AreWeStrict : Type := Strict : AreWeStrict
                             |  Lazy : AreWeStrict.

Inductive Altered k a : Type := AltSmaller : (Map k a) -> Altered k a
...
Definition dropMissing {f} {k} {x} {y} `{GHC.Base.Applicative f} : WhenMissing f
                                                                   k x y :=
              ...
              := match arg_0__ with
                   ...
                   | Bin num_1__ k v _ _ => if num_1__ GHC.Base.== GHC.Num.fromInteger 1 : bool
                                            then f k v
                                                   ...
                                                   | Bin _ k v l r => GHC.Base.mappend (go l) (GHC.Base.mappend (f k v)
                                                                                                                (go r))
                                                   | _ => patternFailure
                                                 end
                 end in
...
Definition fromSet {k} {a} : (k -> a) -> Data.Set.Internal.Set_ k -> Map k a :=
  fix fromSet arg_0__ arg_1__
        := match arg_0__ , arg_1__ with
             ...
             | f , Data.Set.Internal.Bin sz x l r => Bin sz x (f x) (fromSet f l) (fromSet f
                                                                                  r)
           end.
...
Definition lmapWhenMissing {b} {a} {f} {k} {x} : (b -> a) -> WhenMissing f k a
                                                 x -> WhenMissing f k b x :=
...
Definition findMax {k} {a} : Map k a -> (k * a)%type :=
  fun t =>
    match lookupMax t with
      | Some r => r
      | _ => GHC.Err.error (GHC.Base.hs_string__
...
Definition lookupTrace {k} {a} `{GHC.Base.Ord k} : k -> Map k a -> TraceResult
                                                   a :=
  let go {k} {a} `{GHC.Base.Ord k}
    : Utils.Containers.Internal.BitQueue.BitQueueB -> k -> Map k a -> TraceResult
      a :=
    fix go arg_0__ arg_1__ arg_2__
          := match arg_0__ , arg_1__ , arg_2__ with
               | q , _ , Tip => Mk_TraceResult None (Utils.Containers.Internal.BitQueue.buildQ
                                                    q)
               | q , k , Bin _ kx x l r => match GHC.Base.compare k kx with
                                             | Lt => (go GHC.Base.$! Utils.Containers.Internal.BitQueue.snocQB q false)
                                                     k l
                                             | Gt => (go GHC.Base.$! Utils.Containers.Internal.BitQueue.snocQB q true) k
                                                     r
                                             | Eq => Mk_TraceResult (Some x) (Utils.Containers.Internal.BitQueue.buildQ
                                                                             q)
                                           end
             end in
...
Definition mapWhenMissing {f} {a} {b} {k} {x} `{GHC.Base.Applicative f}
                          `{GHC.Base.Monad f} : (a -> b) -> WhenMissing f k x a -> WhenMissing f k x b :=
  fun f t => Mk_WhenMissing missingValue missingValue.
...
Definition replaceAlong {a} {k}
  ...
  fix replaceAlong arg_0__ arg_1__ arg_2__
        := match arg_0__ , arg_1__ , arg_2__ with
             | _ , _ , Tip => Tip
             | q , x , Bin sz ky y l r => match Utils.Containers.Internal.BitQueue.unconsQ
                                                  q with
...
Definition runWhenMatched {f} {k} {x} {y} {z} : WhenMatched f k x y
                                                z -> k -> x -> y -> f (option z) :=
  matchedKey.
...
Definition runWhenMissing {f} {k} {x} {y} : WhenMissing f k x y -> k -> x -> f
                                            (option y) :=
  missingKey.
...
Definition minViewSure {k} {a} : k -> a -> Map k a -> Map k a -> MinView k a :=
  let fix go arg_0__ arg_1__ arg_2__ arg_3__
            := match arg_0__ , arg_1__ , arg_2__ , arg_3__ with
                 ...
                 | k , x , Bin _ kl xl ll lr , r => match go kl xl ll lr with
                                                      | Mk_MinView km xm l' => Mk_MinView km xm (balanceR k x l' r)
                                                    end
               end in
  go.
...
Definition minViewWithKey {k} {a} : Map k a -> option ((k * a)%type * Map k
  ...
  fun arg_0__ =>
    match arg_0__ with
      | Tip => None
      | Bin _ k x l r => Some GHC.Base.$ (match minViewSure k x l r with
                           | Mk_MinView km xm t => pair (pair km xm) t
                         end)
    end.
...
Definition deleteFindMin {k} {a} : Map k a -> ((k * a)%type * Map k a)%type :=
  fun t =>
    match minViewWithKey t with
      | None => pair (GHC.Err.error (GHC.Base.hs_string__
    ...
    let go {k} {a} `{GHC.Base.Ord k} : k -> k -> a -> Map k a -> Map k a :=
      fix go arg_0__ arg_1__ arg_2__ arg_3__
            := match arg_0__ , arg_1__ , arg_2__ , arg_3__ with
                 ...
                 | orig , kx , x , (Bin sz ky y l r as t) => match GHC.Base.compare kx ky with
                                                               | Lt => match go orig kx x l with
                                                                         | l' =>
                                                                           if Utils.Containers.Internal.PtrEquality.ptrEq
                                                                              l' l : bool
                                                                           then t
                                                                           else balanceL ky y l' r
                                                                       end
                                                               | Gt => match go orig kx x r with
                                                                         | r' =>
                                                                           if Utils.Containers.Internal.PtrEquality.ptrEq
                                                                              r' r : bool
                                                                           then t
                                                               ...
                                                               | Eq => if andb
                                                                          (Utils.Containers.Internal.PtrEquality.ptrEq x
                                                                                                                       y)
                                                                          (GHC.Prim.seq orig
...
Definition insertAlong {k} {a}
    : Utils.Containers.Internal.BitQueue.BitQueue -> k -> a -> Map k a -> Map k a :=
            ...
            := match arg_0__ , arg_1__ , arg_2__ , arg_3__ with
                 ...
                 | f , kx , x , Bin sy ky y l r => match GHC.Base.compare kx ky with
                                                     | Lt => match go f kx x l with
                                                               | pair found l' => match balanceL ky y l' r with
                                                                                    | t' => (pair found t')
                                                                                  end
                                                             end
                                                     | Gt => match go f kx x r with
                                                               | pair found r' => match balanceR ky y l r' with
                                                                                    | t' => (pair found t')
                                                                                  end
                                                             end
  ...
  fun kx0 =>
    let go {k} {a} `{GHC.Base.Ord k} : k -> k -> a -> Map k a -> Map k a :=
      fix go arg_0__ arg_1__ arg_2__ arg_3__
            := match arg_0__ , arg_1__ , arg_2__ , arg_3__ with
                 | orig , _ , x , Tip => singleton (orig) x
                 | orig , kx , x , (Bin _ ky y l r as t) => match GHC.Base.compare kx ky with
                                                              | Lt => match go orig kx x l with
                                                                        | l' =>
                                                                          if Utils.Containers.Internal.PtrEquality.ptrEq
                                                                             l' l : bool
...
Definition insertWith {k} {a} `{GHC.Base.Ord k} : (a -> a -> a) -> k -> a -> Map
                                                  k a -> Map k a :=
  let go {k} {a} `{GHC.Base.Ord k} : (a -> a -> a) -> k -> a -> Map k a -> Map k
                                     a :=
    fix go arg_0__ arg_1__ arg_2__ arg_3__
          := match arg_0__ , arg_1__ , arg_2__ , arg_3__ with
               | _ , kx , x , Tip => singleton kx x
                                                  ...
                                                  | s , (cons x' xs' as xs) => if s GHC.Base.== GHC.Num.fromInteger
                                                                               ...
                                                                               then match x' with
                                                                                      ...
                                                                                      | pair l (cons (pair ky y) ys) =>
                                                                                        match create (Data.Bits.shiftR s
                                                                                                                       (GHC.Num.fromInteger
                                                                                                                       1))
                                                                                                ys with
...
Definition fromAscList {k} {a} `{GHC.Base.Eq_ k} : list (k * a)%type -> Map k
  ...
  fun xs =>
    let fix combineEq' arg_0__ arg_1__
              := match arg_0__ , arg_1__ with
                   | z , nil => cons z nil
                   | (pair kz _ as z) , cons (pair kx xx as x) xs' => if kx GHC.Base.== kz : bool
      ...
      | cons (pair kx0 x0) xs0 => let create :=
                                  ...
                                  let go :=
                                    unsafeFix (fun go arg_15__ arg_16__ arg_17__ =>
                                                match arg_15__ , arg_16__ , arg_17__ with
                                                  | _ , t , nil => t
                                                  | s , r , cons (pair kx x) xs => match create s xs with
                                                                                     | pair l ys => match link kx x l
                                                                                                            r with
                                                                                                      | t' => go
                                                                                                              (Data.Bits.shiftL
                                                                                                              s
...
Definition fromDescList {k} {a} `{GHC.Base.Eq_ k} : list (k * a)%type -> Map k
                                                    a :=
  fun xs =>
    let fix combineEq' arg_0__ arg_1__
              := match arg_0__ , arg_1__ with
...
Definition fromDescListWith {k} {a} `{GHC.Base.Eq_ k} : (a -> a -> a) -> list (k
                                                                              * a)%type -> Map k a :=
  fun f xs =>
                                  ...
                                  let go :=
                                    unsafeFix (fun go arg_28__ arg_29__ arg_30__ =>
                                                match arg_28__ , arg_29__ , arg_30__ with
                                                  ...
                                                  | s , l , (cons (pair kx x) xss as xs) => if not_ordered kx xss : bool
                                                                                            then fromList' l xs
...
Definition spanAntitone {k} {a} : (k -> bool) -> Map k a -> (Map k a * Map k
                                  a)%type :=
  fun p0 m =>
    let fix go arg_0__ arg_1__
              := match arg_0__ , arg_1__ with
                   ...
                   | p , Bin _ kx x l r => if p kx : bool
                                           then match go p r with
                                                  | pair u v => pair (link kx x l u) v
                                                end
                                           else match go p l with
                                                  | pair u v => pair u (link kx x v r)
                                                end
                 end in
    id (go p0 m).
...
Definition splitLookup {k} {a} `{GHC.Base.Ord k} : k -> Map k a -> (Map k a *
  ...
  fun k0 m =>
    let go {k} {a} `{GHC.Base.Ord k} : k -> Map k a -> StrictTriple (Map k a)
                                       (option a) (Map k a) :=
      fix go k t
            := match t with
                 ...
                 | Bin _ kx x l r => match GHC.Base.compare k kx with
                                       | Lt => match go k l with
                                                 | Mk_StrictTriple lt z gt => match link kx x gt r with
                                                                                | gt' => Mk_StrictTriple lt z gt'
                                                                              end
                                               end
                                       | Gt => match go k r with
                                                 | Mk_StrictTriple lt z gt => match link kx x l lt with
                                                                                | lt' => Mk_StrictTriple lt' z gt
                                                                              end
                                               end
    ...
    match go k0 m with
      | Mk_StrictTriple l mv r => pair (pair l mv) r
    end.
...
Definition splitMember {k} {a} `{GHC.Base.Ord k} : k -> Map k a -> (Map k a *
                                                   bool * Map k a)%type :=
  fun k0 m =>
    let go {k} {a} `{GHC.Base.Ord k} : k -> Map k a -> StrictTriple (Map k a) bool
                                       (Map k a) :=
      fix go k t
            := match t with
...
Definition union {k} {a} `{GHC.Base.Ord k} : Map k a -> Map k a -> Map k a :=
  fix union arg_0__ arg_1__
        := match arg_0__ , arg_1__ with
             ...
             | Tip , t2 => t2
             | (Bin _ k1 x1 l1 r1 as t1) , t2 => match split k1 t2 with
...
Definition unionWith {k} {a} `{GHC.Base.Ord k} : (a -> a -> a) -> Map k a -> Map
  ...
  fix unionWith arg_0__ arg_1__ arg_2__
        := match arg_0__ , arg_1__ , arg_2__ with
             ...
             | _f , Tip , t2 => t2
             | f , Bin _ k1 x1 l1 r1 , t2 => match splitLookup k1 t2 with
                                               | pair (pair l2 mb) r2 => match unionWith f r1 r2 with
                                                                           | r1r2 => match unionWith f l1 l2 with
                                                                                       | l1l2 => match mb with
                                                                                                   | None => link k1 x1
                                                                                                             l1l2 r1r2
                                                                                                   | Some x2 => link k1
...
Definition unionWithKey {k} {a} `{GHC.Base.Ord k} : (k -> a -> a -> a) -> Map k
  ...
  fix unionWithKey arg_0__ arg_1__ arg_2__
        := match arg_0__ , arg_1__ , arg_2__ with
             ...
             | _f , Tip , t2 => t2
             | f , Bin _ k1 x1 l1 r1 , t2 => match splitLookup k1 t2 with
                                               | pair (pair l2 mb) r2 => match unionWithKey f r1 r2 with
                                                                           | r1r2 => match unionWithKey f l1 l2 with
                                                                                       | l1l2 => match mb with
                                                                                                   | None => link k1 x1
                                                                                                             l1l2 r1r2
                                                                                                   | Some x2 => link k1
...
Definition maxViewSure {k} {a} : k -> a -> Map k a -> Map k a -> MaxView k a :=
  let fix go arg_0__ arg_1__ arg_2__ arg_3__
            := match arg_0__ , arg_1__ , arg_2__ , arg_3__ with
                 ...
                 | k , x , l , Bin _ kr xr rl rr => match go kr xr rl rr with
                                                      | Mk_MaxView km xm r' => Mk_MaxView km xm (balanceL k x l r')
                                                    end
               end in
  go.
...
Definition maxViewWithKey {k} {a} : Map k a -> option ((k * a)%type * Map k
  ...
  fun arg_0__ =>
    match arg_0__ with
      | Tip => None
      | Bin _ k x l r => Some GHC.Base.$ (match maxViewSure k x l r with
                           | Mk_MaxView km xm t => pair (pair km xm) t
                         end)
    end.
...
Definition glue {k} {a} : Map k a -> Map k a -> Map k a :=
  fun arg_0__ arg_1__ =>
    match arg_0__ , arg_1__ with
      | Tip , r => r
      | l , Tip => l
      | (Bin sl kl xl ll lr as l) , (Bin sr kr xr rl rr as r) => if sl GHC.Base.>
                                                                    sr : bool
                                                                 then match maxViewSure kl xl ll lr with
                                                                        | Mk_MaxView km m l' => balanceR km m l' r
                                                                      end
                                                                 else match minViewSure kr xr rl rr with
                                                                        | Mk_MinView km m r' => balanceL km m l r'
                                                                      end
    end.
...
Definition delete {k} {a} `{GHC.Base.Ord k} : k -> Map k a -> Map k a :=
  let go {k} {a} `{GHC.Base.Ord k} : k -> Map k a -> Map k a :=
    fix go arg_0__ arg_1__
          := match arg_0__ , arg_1__ with
               | _ , Tip => Tip
               | k , (Bin _ kx x l r as t) => match GHC.Base.compare k kx with
                                                | Lt => match go k l with
...
Definition filterWithKey {k} {a} : (k -> a -> bool) -> Map k a -> Map k a :=
  fix filterWithKey arg_0__ arg_1__
        := match arg_0__ , arg_1__ with
             | _ , Tip => Tip
             | p , (Bin _ kx x l r as t) => match filterWithKey p r with
                                              | pr => match filterWithKey p l with
                                                        | pl => if p kx x : bool
                                                                then if andb
                                                                        (Utils.Containers.Internal.PtrEquality.ptrEq pl
                                                                                                                     l)
                                                                        (Utils.Containers.Internal.PtrEquality.ptrEq pr
                                                                                                                     r) : bool
                                                                     then t
...
Definition filterWithKeyA {f} {k} {a} `{GHC.Base.Applicative f} : (k -> a -> f
                                                                  bool) -> Map k a -> f (Map k a) :=
  fix filterWithKeyA arg_0__ arg_1__
        := match arg_0__ , arg_1__ with
             | _ , Tip => GHC.Base.pure Tip
             | p , (Bin _ kx x l r as t) => let combine :=
...
Definition intersection {k} {a} {b} `{GHC.Base.Ord k} : Map k a -> Map k
  ...
  fix intersection arg_0__ arg_1__
        := match arg_0__ , arg_1__ with
             | Tip , _ => Tip
             | _ , Tip => Tip
             | (Bin _ k x l1 r1 as t1) , t2 => match splitMember k t2 with
                                                 | pair (pair l2 mb) r2 => match intersection l1 l2 with
...
Definition intersectionWith {k} {a} {b} {c} `{GHC.Base.Ord k}
  ...
  fix intersectionWith arg_0__ arg_1__ arg_2__
        := match arg_0__ , arg_1__ , arg_2__ with
             | _f , Tip , _ => Tip
             | _f , _ , Tip => Tip
             | f , Bin _ k x1 l1 r1 , t2 => match splitLookup k t2 with
                                              | pair (pair l2 mb) r2 => match intersectionWith f l1 l2 with
                                                                          | l1l2 => match intersectionWith f r1 r2 with
                                                                                      | r1r2 => match mb with
                                                                                                  | Some x2 => link k (f
                                                                                                                      x1
                                                                                                                      x2)
...
Definition intersectionWithKey {k} {a} {b} {c} `{GHC.Base.Ord k}
  ...
  fix intersectionWithKey arg_0__ arg_1__ arg_2__
        := match arg_0__ , arg_1__ , arg_2__ with
             ...
             | _f , _ , Tip => Tip
             | f , Bin _ k x1 l1 r1 , t2 => match splitLookup k t2 with
                                              | pair (pair l2 mb) r2 => match intersectionWithKey f l1 l2 with
                                                                          | l1l2 => match intersectionWithKey f r1
                                                                                            r2 with
                                                                                      | r1r2 => match mb with
                                                                                                  | Some x2 => link k (f
                                                                                                                      k
                                             ...
                                             | pair r1 r2 => match go f l with
                                                               | pair l1 l2 => match f kx x with
                                                                                 | Data.Either.Left y => pair (link kx y
                                                                                                              ...
                                                                                                              (link2 l2
                                                                                                              r2)
                                                                                 | Data.Either.Right z => pair (link2 l1
                                                                                                               r1) (link
                                                                                                               kx z l2
                                                                                                               r2)
                                                                               end
...
Definition mergeA {f} {k} {a} {c} {b} `{GHC.Base.Applicative f} `{GHC.Base.Ord
                  k} : WhenMissing f k a c -> WhenMissing f k b c -> WhenMatched f k a b c -> Map
                       k a -> Map k b -> f (Map k c) :=
  fun arg_0__ arg_1__ arg_2__ =>
    match arg_0__ , arg_1__ , arg_2__ with
      | Mk_WhenMissing g1t g1k , Mk_WhenMissing g2t _ , Mk_WhenMatched f => let fix go
                                                                                      arg_3__ arg_4__
                                                                                      := match arg_3__ , arg_4__ with
                                                                                           | t1 , Tip => g1t t1
                                                                                           | Tip , t2 => g2t t2
                                                                                           | Bin _ kx x1 l1 r1 , t2 =>
                                                                                             match splitLookup kx
                                                                                                     t2 with
                                                                                               | pair (pair l2 mx2)
                                                                                                      r2 => match go r1
                                                                                                                    r2 with
  ...
  fun f g1 g2 =>
    let fix go arg_0__ arg_1__
              := match arg_0__ , arg_1__ with
                   | Tip , t2 => g2 t2
                   | t1 , Tip => g1 t1
                   | Bin _ kx x l1 r1 , t2 => match splitLookup kx t2 with
                                                | pair (pair l2 found) r2 => let l' := go l1 l2 in
                                                                             let r' := go r1 r2 in
                                                                             match found with
                                                                               | None => match g1 (singleton kx x) with
                                                                                           | Tip => link2 l' r'
                                                                                           | Bin _ _ x' Tip Tip => link
                                                                                                                   kx x'
                                                                                                                   l' r'
                                                                                           | _ => GHC.Err.error
...
Definition partitionWithKey {k} {a} : (k -> a -> bool) -> Map k a -> (Map k a *
  ...
  fun p0 t0 =>
    let fix go arg_0__ arg_1__
              := match arg_0__ , arg_1__ with
                   | _ , Tip => (pair Tip Tip)
                   | p , (Bin _ kx x l r as t) => match go p r with
                                                    | pair r1 r2 => match go p l with
                                                                      | pair l1 l2 => if p kx x : bool
                                                                                      then pair (if andb
                                                                                                    ...
                                                                                                    r1 r) : bool
                                                                                                then t
                                                                                                else link kx x l1 r1)
                                                                                                (link2 l2 r2)
                                                                                      else pair (link2 l1 r1) (if andb
                                                                                                                  (Utils.Containers.Internal.PtrEquality.ptrEq
                                                                                                                  l2 l)
                                                                                                                  (Utils.Containers.Internal.PtrEquality.ptrEq
                                                                                                                  r2
...
Definition restrictKeys {k} {a} `{GHC.Base.Ord k} : Map k
                                                    a -> Data.Set.Internal.Set_ k -> Map k a :=
  fix restrictKeys arg_0__ arg_1__
        := match arg_0__ , arg_1__ with
             | Tip , _ => Tip
             | _ , Data.Set.Internal.Tip => Tip
             | (Bin _ k x l1 r1 as m) , s => match Data.Set.Internal.splitMember k s with
                                               | pair (pair l2 b) r2 => match restrictKeys l1 l2 with
                                                                          | l1l2 => match restrictKeys r1 r2 with
                                                                                      | r1r2 => if b : bool
                                                                                                then if andb
                                                                                                        (Utils.Containers.Internal.PtrEquality.ptrEq
                                                                                                        l1l2 l1)
...
Definition traverseMaybeWithKey {f} {k} {a} {b} `{GHC.Base.Applicative f}
  ...
  let fix go arg_0__ arg_1__
            := match arg_0__ , arg_1__ with
                 | _ , Tip => GHC.Base.pure Tip
                 | f , Bin _ kx x Tip Tip => Data.Maybe.maybe Tip (fun x' =>
                                                                    Bin (GHC.Num.fromInteger 1) kx x' Tip Tip)
                                             Data.Functor.<$> f kx x
                 | f , Bin _ kx x l r => let combine :=
                                           fun l' mx r' =>
                                             match mx with
                                               | None => link2 l' r'
...
Definition withoutKeys {k} {a} `{GHC.Base.Ord k} : Map k
                                                   a -> Data.Set.Internal.Set_ k -> Map k a :=
  fix withoutKeys arg_0__ arg_1__
        := match arg_0__ , arg_1__ with
             | Tip , _ => Tip
             | m , Data.Set.Internal.Tip => m
             | m , Data.Set.Internal.Bin _ k ls rs => match splitMember k m with
                                                        | pair (pair lm b) rm => match withoutKeys rm rs with
                                                                                   | rm' => match withoutKeys lm ls with
                                                                                              | lm' => if andb (negb b)
                                                                                                               (andb
                                                                                                               (Utils.Containers.Internal.PtrEquality.ptrEq
                                                                                                               lm' lm)
...
Definition updateLookupWithKey {k} {a} `{GHC.Base.Ord k} : (k -> a -> option
  ...
  fun f0 k0 =>
    let go {k} {a} `{GHC.Base.Ord k} : (k -> a -> option a) -> k -> Map k a -> prod
                                       (option a) (Map k a) :=
      fix go arg_0__ arg_1__ arg_2__
            := match arg_0__ , arg_1__ , arg_2__ with
                 ...
                 | f , k , Bin sx kx x l r => match GHC.Base.compare k kx with
                                                | Lt => match go f k l with
                                                          | pair found l' => match balanceR kx x l' r with
                                                                               | t' => (pair found t')
                                                                             end
                                                        end
                                                | Gt => match go f k r with
                                                          | pair found r' => match balanceL kx x l r' with
                                                                               | t' => (pair found t')
                                                                             end
                                                        end
                                                | Eq => match f kx x with
                                                          | Some x' => (pair (Some x') (Bin sx kx x' l r))
                                                          | None => match glue l r with
                                                                      | glued => (pair (Some x) glued)
                                                                    end
                                                        end
                                              end
               end in
...
Definition atKeyPlain {k} {a} `{GHC.Base.Ord k} : AreWeStrict -> k -> (option
                                                  a -> option a) -> Map k a -> Map k a :=
  fun strict k0 f0 t =>
    let go {k} {a} `{GHC.Base.Ord k} : k -> (option a -> option a) -> Map k
                                       a -> Altered k a :=
      fix go arg_0__ arg_1__ arg_2__
            := match arg_0__ , arg_1__ , arg_2__ with
                 | k , f , Tip => match f None with
                                    | None => AltSame
                                    | Some x => match strict with
                                                  | Lazy => AltBigger GHC.Base.$ singleton k x
                                                  | Strict => GHC.Prim.seq x (AltBigger GHC.Base.$ singleton k x)
                                                end
                                  end
                 | k , f , Bin sx kx x l r => match GHC.Base.compare k kx with
                                                | Lt => match go k f l with
                                                ...
                                                | Eq => match f (Some x) with
                                                          | Some x' => match strict with
                                                                         ...
                                                                         | Strict => GHC.Prim.seq x' (AltAdj GHC.Base.$
                                                                                                  Bin sx kx x' l r)
                                                                       end
...
Definition atKeyIdentity {k} {a} `{GHC.Base.Ord k} : k -> (option
                                                     a -> Data.Functor.Identity.Identity (option a)) -> Map k
                                                     a -> Data.Functor.Identity.Identity (Map k a) :=
  fun k f t =>
    Data.Functor.Identity.Mk_Identity GHC.Base.$ atKeyPlain Lazy k (GHC.Prim.coerce
                                                                   f) t.
...
Definition splitAt {k} {a} : GHC.Num.Int -> Map k a -> (Map k a * Map k
                             a)%type :=
  fun i0 m0 =>
    let fix go arg_0__ arg_1__
              := match arg_0__ , arg_1__ with
                                     ...
                                     | i , Bin _ kx x l r => let sizeL := size l in
                                                             match GHC.Base.compare i sizeL with
                                                               | Lt => match go i l with
                                                                         | pair ll lr => pair ll (link kx x lr r)
                                                                       end
                                                               | Gt => match go ((i GHC.Num.- sizeL) GHC.Num.-
                                                                                GHC.Num.fromInteger 1) r with
                                                                         | pair rl rr => pair (link kx x l rl) rr
                                                                       end
...
Definition difference {k} {a} {b} `{GHC.Base.Ord k} : Map k a -> Map k b -> Map
  ...
  fix difference arg_0__ arg_1__
        := match arg_0__ , arg_1__ with
             | Tip , _ => Tip
             | t1 , Tip => t1
             | t1 , Bin _ k _ l2 r2 => match split k t1 with
                                ...
                                | Bin rs rk rx rl rr => if rs GHC.Base.> (delta GHC.Num.* ls) : bool
                                                        then let scrut_24__ := pair rl rr in
                                                             match scrut_24__ with
                                                               ...
                                                               | _ => match scrut_24__ with
                                                                        | pair _ _ => GHC.Err.error
                                                                                      (GHC.Base.hs_string__
                   ...
                   | Bin num_1__ k v _ _ => if num_1__ GHC.Base.== GHC.Num.fromInteger 1 : bool
                                            then (fun v' => Bin (GHC.Num.fromInteger 1) k v' Tip Tip) Data.Functor.<$> f
                                                 k v
                                                   ...
                                                   | Bin s k v l r => GHC.Base.liftA3 (GHC.Base.flip (Bin s k)) (go l)
                                                                      (f k v) (go r)
                                                   | _ => patternFailure
                                                 end
                 end in
...
Definition zipWithMaybeAMatched {k} {x} {y} {f} {z} : (k -> x -> y -> f (option
                                                                        z)) -> WhenMatched f k x y z :=
