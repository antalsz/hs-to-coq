...
Definition deleteList {key} {elt} `{GHC.Base.Ord key} : list
                                                        key -> Data.Map.Internal.Map key elt -> Data.Map.Internal.Map
                                                        key elt :=
...
Definition insertList {key} {elt} `{GHC.Base.Ord key} : list (key *
                                                             elt)%type -> Data.Map.Internal.Map key
                                                        elt -> Data.Map.Internal.Map key elt :=
  fun xs m =>
...
Definition insertListWith {key} {elt} `{GHC.Base.Ord key}
    : (elt -> elt -> elt) -> list (key * elt)%type -> Data.Map.Internal.Map key
      elt -> Data.Map.Internal.Map key elt :=
  fun f xs m0 =>
    Data.Foldable.foldl (fun arg_0__ arg_1__ =>
                          match arg_0__ , arg_1__ with
