...
Definition hashDotop___ {b} {c} {a} `{GHC.Types.Coercible b c}
    : (b -> c) -> (a -> b) -> (a -> c) :=
  fun arg_76__ => match arg_76__ with | _f => GHC.Prim.coerce end.
    ...
    fun arg_44__ arg_45__ =>
      match arg_44__ , arg_45__ with
        | f , xs => let mf :=
                    ...
                    Data.Maybe.fromMaybe (GHC.Prim.errorWithoutStackTrace
        ...
        | f , z0 , xs => let f' :=
                           fun arg_12__ arg_13__ arg_14__ =>
                             match arg_12__ , arg_13__ , arg_14__ with
                               | k , x , z => GHC.BaseGen.op_zdzn__ k (f x z)
                             end in
                         instance_Foldable_option_foldl f' GHC.BaseGen.id xs z0
      end.
...
Local Definition instance_Foldable_option_toList : forall {a},
  ...
  fun {a} =>
    fun arg_54__ =>
      match arg_54__ with
        | t => Prim.build (fun _ arg_55__ arg_56__ =>
        ...
        | f , z0 , xs => let f' :=
                           fun arg_27__ arg_28__ arg_29__ =>
                             match arg_27__ , arg_28__ , arg_29__ with
                               | x , k , z => GHC.BaseGen.op_zdzn__ k (f z x)
                             end in
                         instance_Foldable_option_foldr f' GHC.BaseGen.id xs z0
      end.
...
Local Definition instance_Foldable_option_foldMap : forall {m} {a},
                                                      forall `{GHC.BaseGen.Monoid m}, (a -> m) -> option a -> m :=
  fun {m} {a} `{GHC.BaseGen.Monoid m} =>
    fun arg_1__ =>
      match arg_1__ with
        | f => instance_Foldable_option_foldr (Coq.Program.Basics.compose
                                              GHC.BaseGen.mappend f) GHC.BaseGen.mempty
      end.
(*
...
Local Definition instance_Foldable_option_fold : forall {m},
                                                   forall `{GHC.BaseGen.Monoid m}, option m -> m :=
  fun {m} `{GHC.BaseGen.Monoid m} =>
    instance_Foldable_option_foldMap GHC.BaseGen.id.

Local Definition instance_Foldable_list_elem : forall {a},
                                                 forall `{GHC.Prim.Eq_ a}, a -> list a -> bool :=
  fun {a} `{GHC.Prim.Eq_ a} => GHC.List.elem.
    ...
    fun arg_9__ arg_10__ arg_11__ =>
      match arg_9__ , arg_10__ , arg_11__ with
        | f , z0 , xs => let f' :=
                         ...
                         instance_Foldable_list_foldl f' GHC.BaseGen.id xs z0
      end.
...
Local Definition instance_Foldable_list_foldr : forall {a} {b},
                                                  (a -> b -> b) -> b -> list a -> b :=
  fun {a} {b} => GHC.BaseGen.foldr.

Local Definition instance_Foldable_list_foldMap : forall {m} {a},
                                                    forall `{GHC.BaseGen.Monoid m}, (a -> m) -> list a -> m :=
  fun {m} {a} `{GHC.BaseGen.Monoid m} =>
    fun arg_1__ =>
      match arg_1__ with
        | f => instance_Foldable_list_foldr (Coq.Program.Basics.compose GHC.BaseGen.mappend
                                                                        f) GHC.BaseGen.mempty
      end.

Local Definition instance_Foldable_list_fold : forall {m},
                                                 forall `{GHC.BaseGen.Monoid m}, list m -> m :=
  fun {m} `{GHC.BaseGen.Monoid m} =>
    instance_Foldable_list_foldMap GHC.BaseGen.id.
...
Local Definition instance_Foldable_list_maximum : forall {a},
                                                    forall `{GHC.Prim.Ord a}, list a -> a :=
  fun {a} `{GHC.Prim.Ord a} => GHC.List.maximum.

Local Definition instance_Foldable_list_minimum : forall {a},
                                                    forall `{GHC.Prim.Ord a}, list a -> a :=
  fun {a} `{GHC.Prim.Ord a} => GHC.List.minimum.
      ...
      match arg_19__ , arg_20__ , arg_21__ with
        | f , z , t => Data.Monoid.appEndo (Data.Monoid.getDual (instance_Foldable__GHC_Tuple_____a__foldMap
                                        (Coq.Program.Basics.compose Data.Monoid.Dual (Coq.Program.Basics.compose
                                                                    Data.Monoid.Endo (GHC.BaseGen.flip f))) t)) z
      end.
    ...
    fun arg_9__ arg_10__ arg_11__ =>
      match arg_9__ , arg_10__ , arg_11__ with
        | f , z0 , xs => let f' :=
                         ...
                         instance_Foldable__GHC_Tuple_____a__foldl f' GHC.BaseGen.id xs z0
      end.
...
Local Definition instance_Foldable__GHC_Tuple_____a__toList : forall {a},
  ...
  fun {a} =>
    fun arg_54__ =>
      match arg_54__ with
        | t => Prim.build (fun arg_55__ arg_56__ =>
                                match arg_55__ , arg_56__ with
    ...
    fun arg_24__ arg_25__ arg_26__ =>
      match arg_24__ , arg_25__ , arg_26__ with
        | f , z0 , xs => let f' :=
                         ...
                         instance_Foldable__GHC_Tuple_____a__foldr f' GHC.BaseGen.id xs z0
      end.
...
Local Definition instance_Foldable__GHC_Arr_Array_i__fold : forall {m},
                                                              forall `{GHC.BaseGen.Monoid m},
                                                                (GHC.Arr.Array i) m -> m :=
  fun {m} `{GHC.BaseGen.Monoid m} =>
    instance_Foldable__GHC_Arr_Array_i__foldMap GHC.BaseGen.id.
  ...
  fun {a} =>
    fun arg_283__ =>
      match arg_283__ with
        | a => GHC.Prim.op_zeze__ (GHC.Arr.numElements a) #0
      end.
...
Local Definition instance_Foldable_Data_Proxy_Proxy_elem : forall {a},
                                                             forall `{GHC.Prim.Eq_ a},
                                                               a -> Data.Proxy.Proxy a -> bool :=
  fun {a} `{GHC.Prim.Eq_ a} => fun arg_275__ arg_276__ => false.

Local Definition instance_Foldable_Data_Proxy_Proxy_fold : forall {m},
                                                             forall `{GHC.BaseGen.Monoid m}, Data.Proxy.Proxy m -> m :=
  fun {m} `{GHC.BaseGen.Monoid m} => fun arg_254__ => GHC.BaseGen.mempty.

Local Definition instance_Foldable_Data_Proxy_Proxy_foldMap : forall {m} {a},
                                                                forall `{GHC.BaseGen.Monoid m},
                                                                  (a -> m) -> Data.Proxy.Proxy a -> m :=
  fun {m} {a} `{GHC.BaseGen.Monoid m} =>
    fun arg_252__ arg_253__ => GHC.BaseGen.mempty.
    ...
    fun arg_9__ arg_10__ arg_11__ =>
      match arg_9__ , arg_10__ , arg_11__ with
        | f , z0 , xs => let f' :=
                         ...
                         instance_Foldable_Data_Proxy_Proxy_foldl f' GHC.BaseGen.id xs z0
      end.
...
Local Definition instance_Foldable_Data_Proxy_Proxy_foldl1 : forall {a},
  ...
  fun {a} =>
    fun arg_263__ arg_264__ => GHC.Prim.errorWithoutStackTrace &"foldl1: Proxy".
*)
Local Definition instance_Foldable_Data_Proxy_Proxy_foldr : forall {a} {b},
                                                              (a -> b -> b) -> b -> Data.Proxy.Proxy a -> b :=
  fun {a} {b} =>
    ...
    fun arg_24__ arg_25__ arg_26__ =>
      match arg_24__ , arg_25__ , arg_26__ with
        | f , z0 , xs => let f' :=
                         ...
                         instance_Foldable_Data_Proxy_Proxy_foldr f' GHC.BaseGen.id xs z0
      end.
...
Local Definition instance_Foldable_Data_Proxy_Proxy_foldr1 : forall {a},
                                                               (a -> a -> a) -> Data.Proxy.Proxy a -> a :=
  fun {a} =>
    fun arg_267__ arg_268__ => GHC.Prim.errorWithoutStackTrace &"foldr1: Proxy".
*)
...
Local Definition instance_Foldable_Data_Monoid_Dual_foldMap : forall {m} {a},
  ...
  fun {m} {a} `{GHC.BaseGen.Monoid m} => GHC.Prim.coerce.

Local Definition instance_Foldable_Data_Monoid_Dual_fold : forall {m},
                                                             forall `{GHC.BaseGen.Monoid m}, Data.Monoid.Dual m -> m :=
  fun {m} `{GHC.BaseGen.Monoid m} =>
    instance_Foldable_Data_Monoid_Dual_foldMap GHC.BaseGen.id.
...
Local Definition instance_Foldable_Data_Monoid_Dual_maximum : forall {a},
                                                                forall `{GHC.Prim.Ord a}, Data.Monoid.Dual a -> a :=
  fun {a} `{GHC.Prim.Ord a} => getDual.
...
Local Definition instance_Foldable_Data_Monoid_Sum_elem : forall {a},
                                                            forall `{GHC.Prim.Eq_ a}, a -> Data.Monoid.Sum a -> bool :=
  fun {a} `{GHC.Prim.Eq_ a} =>
...
Local Definition instance_Foldable_Data_Monoid_Sum_fold : forall {m},
                                                            forall `{GHC.BaseGen.Monoid m}, Data.Monoid.Sum m -> m :=
  fun {m} `{GHC.BaseGen.Monoid m} =>
    instance_Foldable_Data_Monoid_Sum_foldMap GHC.BaseGen.id.
...
Local Definition instance_Foldable_Data_Monoid_Sum_maximum : forall {a},
                                                               forall `{GHC.Prim.Ord a}, Data.Monoid.Sum a -> a :=
  fun {a} `{GHC.Prim.Ord a} => getSum.
...
Local Definition instance_Foldable_Data_Monoid_Product_fold : forall {m},
  ...
  fun {m} `{GHC.BaseGen.Monoid m} =>
    instance_Foldable_Data_Monoid_Product_foldMap GHC.BaseGen.id.
...
Local Definition instance_Foldable_Data_Monoid_Product_maximum : forall {a},
                                                                   forall `{GHC.Prim.Ord a},
                                                                     Data.Monoid.Product a -> a :=
  fun {a} `{GHC.Prim.Ord a} => getProduct.
    ...
    fun arg_9__ arg_10__ arg_11__ =>
      match arg_9__ , arg_10__ , arg_11__ with
        | f , z0 , xs => let f' :=
                         ...
                         instance_Foldable_Data_Monoid_First_foldl f' GHC.BaseGen.id xs z0
      end.
    ...
    fun arg_24__ arg_25__ arg_26__ =>
      match arg_24__ , arg_25__ , arg_26__ with
        | f , z0 , xs => let f' :=
                         ...
                         instance_Foldable_Data_Monoid_First_foldr f' GHC.BaseGen.id xs z0
      end.
...
Local Definition instance_Foldable_Data_Monoid_First_fold : forall {m},
  ...
  fun {m} `{GHC.BaseGen.Monoid m} =>
    instance_Foldable_Data_Monoid_First_foldMap GHC.BaseGen.id.
    ...
    fun arg_9__ arg_10__ arg_11__ =>
      match arg_9__ , arg_10__ , arg_11__ with
        | f , z0 , xs => let f' :=
                         ...
                         instance_Foldable_Data_Monoid_Last_foldl f' GHC.BaseGen.id xs z0
      end.
    ...
    fun arg_24__ arg_25__ arg_26__ =>
      match arg_24__ , arg_25__ , arg_26__ with
        | f , z0 , xs => let f' :=
                         ...
                         instance_Foldable_Data_Monoid_Last_foldr f' GHC.BaseGen.id xs z0
      end.
...
Local Definition instance_Foldable_Data_Monoid_Last_fold : forall {m},
                                                             forall `{GHC.BaseGen.Monoid m}, Data.Monoid.Last m -> m :=
  fun {m} `{GHC.BaseGen.Monoid m} =>
    instance_Foldable_Data_Monoid_Last_foldMap GHC.BaseGen.id.
*)
(* Translating `instance forall `{GHC.Prim.Ord a}, GHC.BaseGen.Monoid (Max a)'
   failed: OOPS! Cannot construct types for this class def: Nothing unsupported *)

(* Translating `instance forall `{GHC.Prim.Ord a}, GHC.BaseGen.Monoid (Min a)'
   failed: OOPS! Cannot construct types for this class def: Nothing unsupported *)

(*
Local Definition instance_Foldable_GHC_Generics_U1_elem : forall {a},
                                                            forall `{GHC.Prim.Eq_ a}, a -> GHC.Generics.U1 a -> bool :=
  fun {a} `{GHC.Prim.Eq_ a} => fun arg_190__ arg_191__ => false.

Local Definition instance_Foldable_GHC_Generics_U1_fold : forall {m},
                                                            forall `{GHC.BaseGen.Monoid m}, GHC.Generics.U1 m -> m :=
  fun {m} `{GHC.BaseGen.Monoid m} => fun arg_169__ => GHC.Base.mempty.
    ...
    fun arg_9__ arg_10__ arg_11__ =>
      match arg_9__ , arg_10__ , arg_11__ with
        | f , z0 , xs => let f' :=
                         ...
                         instance_Foldable_GHC_Generics_U1_foldl f' GHC.BaseGen.id xs z0
      end.

Local Definition instance_Foldable_GHC_Generics_U1_foldl1 : forall {a},
                                                              (a -> a -> a) -> GHC.Generics.U1 a -> a :=
  fun {a} =>
    fun arg_178__ arg_179__ => GHC.Prim.errorWithoutStackTrace &"foldl1: U1".
    ...
    fun arg_24__ arg_25__ arg_26__ =>
      match arg_24__ , arg_25__ , arg_26__ with
        | f , z0 , xs => let f' :=
                         ...
                         instance_Foldable_GHC_Generics_U1_foldr f' GHC.BaseGen.id xs z0
      end.

Local Definition instance_Foldable_GHC_Generics_U1_foldr1 : forall {a},
                                                              (a -> a -> a) -> GHC.Generics.U1 a -> a :=
  fun {a} =>
    fun arg_182__ arg_183__ => GHC.Prim.errorWithoutStackTrace &"foldr1: U1".
...
Local Definition instance_Foldable__GHC_Tuple_____a__fold {a} : forall {m},
                                                              forall `{GHC.BaseGen.Monoid m},
                                                                (a * m) -> m :=
  fun {m} `{GHC.BaseGen.Monoid m} =>
    instance_Foldable__GHC_Tuple_____a__foldMap GHC.BaseGen.id.
*)
Class Foldable t := {
  elem : forall {a}, forall `{GHC.Prim.Eq_ a}, a -> t a -> bool ;
  fold : forall {m}, forall `{GHC.BaseGen.Monoid m}, t m -> m ;
  foldMap : forall {m} {a}, forall `{GHC.BaseGen.Monoid m}, (a -> m) -> t a -> m ;
  ...
  maximum : forall {a}, forall `{GHC.Prim.Ord a}, t a -> a ;
  minimum : forall {a}, forall `{GHC.Prim.Ord a}, t a -> a ;
...
Definition traverse_ {t} {f} {a} {b} `{Foldable t} `{GHC.BaseGen.Applicative f}
    : (a -> f b) -> t a -> f unit :=
  fun arg_143__ =>
    match arg_143__ with
      | f => foldr (Coq.Program.Basics.compose GHC.BaseGen.op_ztzg__ f) (GHC.BaseGen.pure
                                                                     tt)
    end.

Definition sequence_ {t} {m} {a} `{Foldable t} `{GHC.BaseGen.Monad m} : t (m
                                                                          a) -> m unit :=
  foldr GHC.BaseGen.op_zgzg__ (GHC.BaseGen.return_ tt).

Definition sequenceA_ {t} {f} {a} `{Foldable t} `{GHC.BaseGen.Applicative f} : t
                                                                               (f a) -> f unit :=
  foldr GHC.BaseGen.op_ztzg__ (GHC.BaseGen.pure tt).

(*
Definition or {t} `{Foldable t} : t bool -> bool :=
  hashDot getAny (foldMap Data.Monoid.Any).
*)
Definition notElem {t} {a} `{Foldable t} `{GHC.Prim.Eq_ a} : a -> t a -> bool :=
  fun arg_84__ =>
    match arg_84__ with
...
Definition mapM_ {t} {m} {a} {b} `{Foldable t} `{GHC.BaseGen.Monad m} : (a -> m
                                                                        b) -> t a -> m unit :=
  fun arg_139__ =>
    match arg_139__ with
      | f => foldr (Coq.Program.Basics.compose GHC.BaseGen.op_zgzg__ f) (GHC.BaseGen.return_
                                                                     tt)
    end.

Definition for_ {t} {f} {a} {b} `{Foldable t} `{GHC.BaseGen.Applicative f} : t
                                                                             a -> (a -> f b) -> f unit :=
  GHC.BaseGen.flip traverse_.

Definition forM_ {t} {m} {a} {b} `{Foldable t} `{GHC.BaseGen.Monad m} : t
                                                                        a -> (a -> m b) -> m unit :=
  GHC.BaseGen.flip mapM_.

Definition foldrM {t} {m} {a} {b} `{Foldable t} `{GHC.BaseGen.Monad m}
    : (a -> b -> m b) -> b -> t a -> m b :=
      ...
      | f , z0 , xs => let f' :=
                         fun arg_160__ arg_161__ arg_162__ =>
                           match arg_160__ , arg_161__ , arg_162__ with
                             | k , x , z => GHC.BaseGen.op_zgzgze__ (f x z) k
                           end in
                       foldl f' GHC.BaseGen.return_ xs z0
    end.

Definition foldlM {t} {m} {b} {a} `{Foldable t} `{GHC.BaseGen.Monad m}
    : (b -> a -> m b) -> b -> t a -> m b :=
      ...
      | f , z0 , xs => let f' :=
                         fun arg_150__ arg_151__ arg_152__ =>
                           match arg_150__ , arg_151__ , arg_152__ with
                             | x , k , z => GHC.BaseGen.op_zgzgze__ (f z x) k
                           end in
                       foldr f' GHC.BaseGen.return_ xs z0
    end.
...
Definition asum {t} {f} {a} `{Foldable t} `{GHC.BaseGen.Alternative f} : t (f
                                                                           a) -> f a :=
  foldr GHC.BaseGen.op_zlzbzg__ GHC.BaseGen.empty.

Definition msum {t} {m} {a} `{Foldable t} `{GHC.BaseGen.MonadPlus m} : t (m a) -> m
                                                                    a :=
  asum.
...
Local Definition instance_Foldable_Data_Monoid_Last_elem : forall {a},
  ...
  fun {a} `{GHC.Prim.Eq_ a} => Coq.Program.Basics.compose any GHC.Prim.op_zeze__.
...
(*Local Definition instance_Foldable_option_elem : forall {a},
                                                   forall `{GHC.Prim.Eq_ a}, a -> option a -> bool :=
  fun {a} `{GHC.Prim.Eq_ a} => Coq.Program.Basics.compose any GHC.Prim.op_zeze__. *)
(*
...
Instance instance_Foldable_Data_Monoid_Product : !Foldable
                                                 Data.Monoid.Product := {
  elem := fun {a} `{GHC.Prim.Eq_ a} =>
    instance_Foldable_Data_Monoid_Product_elem ;
  fold := fun {m} `{GHC.BaseGen.Monoid m} =>
    instance_Foldable_Data_Monoid_Product_fold ;
  foldMap := fun {m} {a} `{GHC.BaseGen.Monoid m} =>
  ...
  maximum := fun {a} `{GHC.Prim.Ord a} =>
    instance_Foldable_Data_Monoid_Product_maximum ;
  minimum := fun {a} `{GHC.Prim.Ord a} =>
...
Instance instance_Foldable_Data_Monoid_Sum : !Foldable Data.Monoid.Sum := {
  elem := fun {a} `{GHC.Prim.Eq_ a} => instance_Foldable_Data_Monoid_Sum_elem ;
  fold := fun {m} `{GHC.BaseGen.Monoid m} =>
...
Instance instance_Foldable_Data_Monoid_Dual : !Foldable Data.Monoid.Dual := {
  elem := fun {a} `{GHC.Prim.Eq_ a} => instance_Foldable_Data_Monoid_Dual_elem ;
  fold := fun {m} `{GHC.BaseGen.Monoid m} =>
    ...
    fun arg_24__ arg_25__ arg_26__ =>
      match arg_24__ , arg_25__ , arg_26__ with
        | f , z0 , xs => let f' :=
                         ...
                         instance_Foldable__sum_a__foldr f' GHC.BaseGen.id xs z0
      end.

Local Definition instance_Foldable__sum_a__foldMap : forall {a0}{m} {a},
                                                       forall `{GHC.BaseGen.Monoid m}, (a -> m) -> (a + a0) -> m :=
  fun {a0} {m} {a} `{GHC.BaseGen.Monoid m} =>
    fun arg_295__ arg_296__ =>
      match arg_295__ , arg_296__ with
        | _ , (inr _) => GHC.BaseGen.mempty
        | f , (inl y) => f y
      end.
    ...
    fun arg_9__ arg_10__ arg_11__ =>
      match arg_9__ , arg_10__ , arg_11__ with
        | f , z0 , xs => let f' :=
                         ...
                         instance_Foldable__sum_a__foldl f' GHC.BaseGen.id xs z0
      end. *)
...
Local Definition instance_Foldable__sum_a__fold : forall {a}{m},
                                                    forall `{GHC.BaseGen.Monoid m}, (m + a) -> m :=
  fun {a}{m} `{GHC.BaseGen.Monoid m} =>
    instance_Foldable__sum_a__foldMap GHC.BaseGen.id.

(*
Local Definition instance_Foldable__sum_a__elem : forall {a},
                                                    forall `{GHC.Prim.Eq_ a}, a -> (sum a) a -> bool :=
  fun {a} `{GHC.Prim.Eq_ a} => Coq.Program.Basics.compose any GHC.Prim.op_zeze__.
*)
Instance instance_Foldable_list : !Foldable list := {
  elem := fun {a} `{GHC.Prim.Eq_ a} => instance_Foldable_list_elem ;
  fold := fun {m} `{GHC.BaseGen.Monoid m} => instance_Foldable_list_fold ;
  foldMap := fun {m} {a} `{GHC.BaseGen.Monoid m} =>
  ...
  maximum := fun {a} `{GHC.Prim.Ord a} => instance_Foldable_list_maximum ;
  minimum := fun {a} `{GHC.Prim.Ord a} => instance_Foldable_list_minimum ;
...
Definition concatMap {t} {a} {b} `{Foldable t} : (a -> list b) -> t a -> list
  ...
  fun arg_113__ arg_114__ =>
    match arg_113__ , arg_114__ with
      | f , xs => Prim.build (fun _ arg_115__ arg_116__ =>
...
Definition concat {t} {a} `{Foldable t} : t (list a) -> list a :=
  fun arg_125__ =>
    match arg_125__ with
      | xs => Prim.build (fun _ arg_126__ arg_127__ =>
...
Local Definition instance_Foldable_GHC_Generics_U1_maximum : forall {a},
                                                               forall `{GHC.Prim.Ord a}, GHC.Generics.U1 a -> a :=
  fun {a} `{GHC.Prim.Ord a} =>
    Coq.Program.Basics.compose (Data.Maybe.fromMaybe
                               (GHC.Prim.errorWithoutStackTrace &"maximum: empty structure"))
                               (Coq.Program.Basics.compose getMax (instance_Foldable_GHC_Generics_U1_foldMap
                                                           (hashDot Mk_Max (Some : a -> option a)))).
*)

Instance instance_forall___GHC_Prim_Ord_a___GHC_BaseGen_Monoid__Max_a_
  : !forall `{GHC.Prim.Ord a}, GHC.BaseGen.Monoid (Max a) := {}.
Proof.
Admitted.

(*
Local Definition instance_Foldable_Data_Monoid_Last_maximum : forall {a},
                                                                forall `{GHC.Prim.Ord a}, Data.Monoid.Last a -> a :=
  fun {a} `{GHC.Prim.Ord a} =>
    Coq.Program.Basics.compose (Data.Maybe.fromMaybe
                               (GHC.Prim.errorWithoutStackTrace &"maximum: empty structure"))
...
Local Definition instance_Foldable_Data_Monoid_First_maximum : forall {a},
                                                                 forall `{GHC.Prim.Ord a}, Data.Monoid.First a -> a :=
  fun {a} `{GHC.Prim.Ord a} =>
    Coq.Program.Basics.compose (Data.Maybe.fromMaybe
                               (GHC.Prim.errorWithoutStackTrace &"maximum: empty structure"))
...
Local Definition instance_Foldable_Data_Proxy_Proxy_maximum : forall {a},
                                                                forall `{GHC.Prim.Ord a}, Data.Proxy.Proxy a -> a :=
  fun {a} `{GHC.Prim.Ord a} =>
    Coq.Program.Basics.compose (Data.Maybe.fromMaybe
                               (GHC.Prim.errorWithoutStackTrace &"maximum: empty structure"))
...
Local Definition instance_Foldable__GHC_Arr_Array_i__maximum : forall {a},
                                                                 forall `{GHC.Prim.Ord a}, (GHC.Arr.Array i) a -> a :=
  fun {a} `{GHC.Prim.Ord a} =>
    Coq.Program.Basics.compose (Data.Maybe.fromMaybe
                               (GHC.Prim.errorWithoutStackTrace &"maximum: empty structure"))
...
Local Definition instance_Foldable__GHC_Tuple_____a__maximum : forall {a},
                                                                 forall `{GHC.Prim.Ord a}, (GHC.Tuple.[,] a) a -> a :=
  fun {a} `{GHC.Prim.Ord a} =>
    Coq.Program.Basics.compose (Data.Maybe.fromMaybe
                               (GHC.Prim.errorWithoutStackTrace &"maximum: empty structure"))
...
Local Definition instance_Foldable__sum_a__maximum : forall {a},
                                                       forall `{GHC.Prim.Ord a}, (sum a) a -> a :=
  fun {a} `{GHC.Prim.Ord a} =>
    Coq.Program.Basics.compose (Data.Maybe.fromMaybe
                               (GHC.Prim.errorWithoutStackTrace &"maximum: empty structure"))
...
Local Definition instance_Foldable_option_maximum : forall {a},
                                                      forall `{GHC.Prim.Ord a}, option a -> a :=
  fun {a} `{GHC.Prim.Ord a} =>
    Coq.Program.Basics.compose (Data.Maybe.fromMaybe
                               (GHC.Prim.errorWithoutStackTrace &"maximum: empty structure"))
...
Local Definition instance_Foldable_GHC_Generics_U1_minimum : forall {a},
  ...
  fun {a} `{GHC.Prim.Ord a} =>
    Coq.Program.Basics.compose (Data.Maybe.fromMaybe
                               (GHC.Prim.errorWithoutStackTrace &"minimum: empty structure"))
...
Instance instance_Foldable_GHC_Generics_U1 : !Foldable GHC.Generics.U1 := {
  elem := fun {a} `{GHC.Prim.Eq_ a} => instance_Foldable_GHC_Generics_U1_elem ;
  fold := fun {m} `{GHC.BaseGen.Monoid m} =>
...
Instance instance_forall___GHC_Prim_Ord_a___GHC_BaseGen_Monoid__Min_a_
  : !forall `{GHC.Prim.Ord a}, GHC.BaseGen.Monoid (Min a) := {}.
Proof.
Admitted.
...
Instance instance_Foldable_Data_Monoid_Last : !Foldable Data.Monoid.Last := {
  elem := fun {a} `{GHC.Prim.Eq_ a} => instance_Foldable_Data_Monoid_Last_elem ;
  fold := fun {m} `{GHC.BaseGen.Monoid m} =>
...
Instance instance_Foldable_Data_Monoid_First : !Foldable Data.Monoid.First := {
  elem := fun {a} `{GHC.Prim.Eq_ a} => instance_Foldable_Data_Monoid_First_elem ;
  fold := fun {m} `{GHC.BaseGen.Monoid m} =>
...
Instance instance_Foldable_Data_Proxy_Proxy : !Foldable Data.Proxy.Proxy := {
  elem := fun {a} `{GHC.Prim.Eq_ a} => instance_Foldable_Data_Proxy_Proxy_elem ;
  fold := fun {m} `{GHC.BaseGen.Monoid m} =>
...
Instance instance_Foldable__GHC_Arr_Array_i_ : !Foldable (GHC.Arr.Array i) := {
  elem := fun {a} `{GHC.Prim.Eq_ a} => instance_Foldable__GHC_Arr_Array_i__elem ;
  fold := fun {m} `{GHC.BaseGen.Monoid m} =>
...
Instance instance_Foldable__GHC_Tuple_____a_ : !Foldable (GHC.Tuple.[,] a) := {
  elem := fun {a} `{GHC.Prim.Eq_ a} => instance_Foldable__GHC_Tuple_____a__elem ;
  fold := fun {m} `{GHC.BaseGen.Monoid m} =>
...
Instance instance_Foldable__sum_a_ : !Foldable (fun x => (a + x)%type) := {
  elem := fun {a} `{GHC.Prim.Eq_ a} => instance_Foldable__sum_a__elem ;
  fold := fun {m} `{GHC.BaseGen.Monoid m} => instance_Foldable__sum_a__fold ;
  foldMap := fun {m} {a} `{GHC.BaseGen.Monoid m} =>
  ...
  maximum := fun {a} `{GHC.Prim.Ord a} => instance_Foldable__sum_a__maximum ;
  minimum := fun {a} `{GHC.Prim.Ord a} => instance_Foldable__sum_a__minimum ;
...
Instance instance_Foldable_option : !Foldable option := {
  elem := fun {a} `{GHC.Prim.Eq_ a} => instance_Foldable_option_elem ;
  fold := fun {m} `{GHC.BaseGen.Monoid m} => instance_Foldable_option_fold ;
  foldMap := fun {m} {a} `{GHC.BaseGen.Monoid m} =>
  ...
  maximum := fun {a} `{GHC.Prim.Ord a} => instance_Foldable_option_maximum ;
  minimum := fun {a} `{GHC.Prim.Ord a} => instance_Foldable_option_minimum ;
...
(* Unbound variables:
     ...
     GHC.Arr.foldrElems' GHC.Arr.numElements GHC.Base.MonadPlus Prim.build
     ...
     GHC.Base.pure GHC.Base.return_ GHC.BaseGen.Alternative GHC.BaseGen.Applicative
     GHC.BaseGen.Monad GHC.BaseGen.Monoid GHC.BaseGen.flip GHC.BaseGen.foldr
     GHC.BaseGen.id GHC.Generics.U1 GHC.List.elem GHC.List.foldl GHC.List.foldl'
     ...
     GHC.Num.Num GHC.Num.op_zp__ GHC.Prim.Eq_ GHC.Prim.Ord GHC.Prim.coerce
     GHC.Prim.errorWithoutStackTrace GHC.Prim.op_zeze__ GHC.Tuple.[,]
