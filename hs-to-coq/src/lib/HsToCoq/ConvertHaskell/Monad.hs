...
{-    , ClassDefinition "Data.Foldable"
    ...
    , ClassDefinition "Data.Foldable.Foldable" [Inferred Explicit (Ident "t")] Nothing [("elem",Forall (Inferred Implicit (Ident "a") :| []) (Forall (Generalized Implicit (App (Qualid (Bare "GHC.Base.Eq_")) (PosArg (Qualid (Bare "a")) :| [])) :| []) (Arrow (Qualid (Bare "a")) (Arrow (App (Qualid (Bare "t")) (PosArg (Qualid (Bare "a")) :| [])) (Qualid (Bare "bool")))))),("fold",Forall (Inferred Implicit (Ident "m") :| []) (Forall (Generalized Implicit (App (Qualid (Bare "GHC.Base.Monoid")) (PosArg (Qualid (Bare "m")) :| [])) :| []) (Arrow (App (Qualid (Bare "t")) (PosArg (Qualid (Bare "m")) :| [])) (Qualid (Bare "m"))))),("foldMap",Forall (Inferred Implicit (Ident "m") :| [Inferred Implicit (Ident "a")]) (Forall (Generalized Implicit (App (Qualid (Bare "GHC.Base.Monoid")) (PosArg (Qualid (Bare "m")) :| [])) :| []) (Arrow (Parens (Arrow (Qualid (Bare "a")) (Qualid (Bare "m")))) (Arrow (App (Qualid (Bare "t")) (PosArg (Qualid (Bare "a")) :| [])) (Qualid (Bare "m")))))),("foldl",Forall (Inferred Implicit (Ident "b") :| [Inferred Implicit (Ident "a")]) (Arrow (Parens (Arrow (Qualid (Bare "b")) (Arrow (Qualid (Bare "a")) (Qualid (Bare "b"))))) (Arrow (Qualid (Bare "b")) (Arrow (App (Qualid (Bare "t")) (PosArg (Qualid (Bare "a")) :| [])) (Qualid (Bare "b")))))),("foldl'",Forall (Inferred Implicit (Ident "b") :| [Inferred Implicit (Ident "a")]) (Arrow (Parens (Arrow (Qualid (Bare "b")) (Arrow (Qualid (Bare "a")) (Qualid (Bare "b"))))) (Arrow (Qualid (Bare "b")) (Arrow (App (Qualid (Bare "t")) (PosArg (Qualid (Bare "a")) :| [])) (Qualid (Bare "b")))))),("foldr",Forall (Inferred Implicit (Ident "a") :| [Inferred Implicit (Ident "b")]) (Arrow (Parens (Arrow (Qualid (Bare "a")) (Arrow (Qualid (Bare "b")) (Qualid (Bare "b"))))) (Arrow (Qualid (Bare "b")) (Arrow (App (Qualid (Bare "t")) (PosArg (Qualid (Bare "a")) :| [])) (Qualid (Bare "b")))))),("foldr'",Forall (Inferred Implicit (Ident "a") :| [Inferred Implicit (Ident "b")]) (Arrow (Parens (Arrow (Qualid (Bare "a")) (Arrow (Qualid (Bare "b")) (Qualid (Bare "b"))))) (Arrow (Qualid (Bare "b")) (Arrow (App (Qualid (Bare "t")) (PosArg (Qualid (Bare "a")) :| [])) (Qualid (Bare "b")))))),("length",Forall (Inferred Implicit (Ident "a") :| []) (Arrow (App (Qualid (Bare "t")) (PosArg (Qualid (Bare "a")) :| [])) (Qualid (Bare "GHC.Num.Int")))),("null",Forall (Inferred Implicit (Ident "a") :| []) (Arrow (App (Qualid (Bare "t")) (PosArg (Qualid (Bare "a")) :| [])) (Qualid (Bare "bool")))),("product",Forall (Inferred Implicit (Ident "a") :| []) (Forall (Generalized Implicit (App (Qualid (Bare "GHC.Num.Num")) (PosArg (Qualid (Bare "a")) :| [])) :| []) (Arrow (App (Qualid (Bare "t")) (PosArg (Qualid (Bare "a")) :| [])) (Qualid (Bare "a"))))),("sum",Forall (Inferred Implicit (Ident "a") :| []) (Forall (Generalized Implicit (App (Qualid (Bare "GHC.Num.Num")) (PosArg (Qualid (Bare "a")) :| [])) :| []) (Arrow (App (Qualid (Bare "t")) (PosArg (Qualid (Bare "a")) :| [])) (Qualid (Bare "a"))))),("toList",Forall (Inferred Implicit (Ident "a") :| []) (Arrow (App (Qualid (Bare "t")) (PosArg (Qualid (Bare "a")) :| [])) (App (Qualid (Bare "list")) (PosArg (Qualid (Bare "a")) :| []))))]
...
{-  x <= y  = compare x y /= GT
    ...
    , "Data.Foldable.Foldable" =:
      ["elem" ~> App (Qualid (Bare "Coq.Program.Basics.compose")) (PosArg (Qualid (Bare "any")) :| [PosArg (Qualid (Bare "GHC.Base.op_zeze__"))]),
       ...
       ("foldl" ~> Fun (Inferred Explicit (Ident "arg_19__") :| [Inferred Explicit (Ident "arg_20__"),Inferred Explicit (Ident "arg_21__")]) (Coq.Match (MatchItem (Qualid (Bare "arg_19__")) Nothing Nothing :| [MatchItem (Qualid (Bare "arg_20__")) Nothing Nothing,MatchItem (Qualid (Bare "arg_21__")) Nothing Nothing]) Nothing [Equation (MultPattern (QualidPat (Bare "f") :| [QualidPat (Bare "z"),QualidPat (Bare "t")]) :| []) (App (App (Qualid (Bare "appEndo")) (PosArg (Parens (App (Qualid (Bare "getDual")) (PosArg (Parens (App (App (Qualid (Bare "foldMap")) (PosArg (Parens (App (Qualid (Bare "Coq.Program.Basics.compose")) (PosArg (Qualid (Bare "Data.Monoid.Mk_Dual")) :| [PosArg (App (Qualid (Bare "Coq.Program.Basics.compose")) (PosArg (Qualid (Bare "Data.Monoid.Endo")) :| [PosArg (App (Qualid (Bare "GHC.Base.flip")) (PosArg (Qualid (Bare "f")) :| []))]))]))) :| [])) (PosArg (Qualid (Bare "t")) :| []))) :| []))) :| [])) (PosArg (Qualid (Bare "z")) :| []))])),
       ...
       ("foldl1"~>Fun (Inferred Explicit (Ident "arg_44__") :| [Inferred Explicit (Ident "arg_45__")]) (Coq.Match (MatchItem (Qualid (Bare "arg_44__")) Nothing Nothing :| [MatchItem (Qualid (Bare "arg_45__")) Nothing Nothing]) Nothing [Equation (MultPattern (QualidPat (Bare "f") :| [QualidPat (Bare "xs")]) :| []) (Let "mf" [] Nothing (Fun (Inferred Explicit (Ident "arg_46__") :| [Inferred Explicit (Ident "arg_47__")]) (Coq.Match (MatchItem (Qualid (Bare "arg_46__")) Nothing Nothing :| [MatchItem (Qualid (Bare "arg_47__")) Nothing Nothing]) Nothing [Equation (MultPattern (QualidPat (Bare "m") :| [QualidPat (Bare "y")]) :| []) (App (Qualid (Bare "Some")) (PosArg (Parens (Coq.Match (MatchItem (Qualid (Bare "m")) Nothing Nothing :| []) Nothing [Equation (MultPattern (QualidPat (Bare "None") :| []) :| []) (Qualid (Bare "y")),Equation (MultPattern (ArgsPat (Bare "Some") (QualidPat (Bare "x") :| []) :| []) :| []) (App (App (Qualid (Bare "f")) (PosArg (Qualid (Bare "x")) :| [])) (PosArg (Qualid (Bare "y")) :| []))])) :| []))])) (App (App (Qualid (Bare "Data.Maybe.fromMaybe")) (PosArg (Parens (App (Qualid (Bare "GHC.Base.errorWithoutStackTrace")) (PosArg (Coq.HsString "foldl1: empty structure") :| []))) :| [])) (PosArg (Parens (App (App (App (Qualid (Bare "foldl")) (PosArg (Qualid (Bare "mf")) :| [])) (PosArg (Qualid (Bare "None")) :| [])) (PosArg (Qualid (Bare "xs")) :| []))) :| [])))])),
       ("foldr"~>Fun (Inferred Explicit (Ident "arg_4__") :| [Inferred Explicit (Ident "arg_5__"),Inferred Explicit (Ident "arg_6__")]) (Coq.Match (MatchItem (Qualid (Bare "arg_4__")) Nothing Nothing :| [MatchItem (Qualid (Bare "arg_5__")) Nothing Nothing,MatchItem (Qualid (Bare "arg_6__")) Nothing Nothing]) Nothing [Equation (MultPattern (QualidPat (Bare "f") :| [QualidPat (Bare "z"),QualidPat (Bare "t")]) :| []) (App (App (Qualid (Bare "appEndo")) (PosArg (Parens (App (App (Qualid (Bare "foldMap")) (PosArg (Parens (App (Qualid (Bare "hash_compose")) (PosArg (Qualid (Bare "Data.Monoid.Endo")) :| [PosArg (Qualid (Bare "f"))]))) :| [])) (PosArg (Qualid (Bare "t")) :| []))) :| [])) (PosArg (Qualid (Bare "z")) :| []))])),
       ...
       ("foldr1"~>Fun (Inferred Explicit (Ident "arg_34__") :| [Inferred Explicit (Ident "arg_35__")]) (Coq.Match (MatchItem (Qualid (Bare "arg_34__")) Nothing Nothing :| [MatchItem (Qualid (Bare "arg_35__")) Nothing Nothing]) Nothing [Equation (MultPattern (QualidPat (Bare "f") :| [QualidPat (Bare "xs")]) :| []) (Let "mf" [] Nothing (Fun (Inferred Explicit (Ident "arg_36__") :| [Inferred Explicit (Ident "arg_37__")]) (Coq.Match (MatchItem (Qualid (Bare "arg_36__")) Nothing Nothing :| [MatchItem (Qualid (Bare "arg_37__")) Nothing Nothing]) Nothing [Equation (MultPattern (QualidPat (Bare "x") :| [QualidPat (Bare "m")]) :| []) (App (Qualid (Bare "Some")) (PosArg (Parens (Coq.Match (MatchItem (Qualid (Bare "m")) Nothing Nothing :| []) Nothing [Equation (MultPattern (QualidPat (Bare "None") :| []) :| []) (Qualid (Bare "x")),Equation (MultPattern (ArgsPat (Bare "Some") (QualidPat (Bare "y") :| []) :| []) :| []) (App (App (Qualid (Bare "f")) (PosArg (Qualid (Bare "x")) :| [])) (PosArg (Qualid (Bare "y")) :| []))])) :| []))])) (App (App (Qualid (Bare "Data.Maybe.fromMaybe")) (PosArg (Parens (App (Qualid (Bare "GHC.Base.errorWithoutStackTrace")) (PosArg (Coq.HsString "foldr1: empty structure") :| []))) :| [])) (PosArg (Parens (App (App (App (Qualid (Bare "foldr")) (PosArg (Qualid (Bare "mf")) :| [])) (PosArg (Qualid (Bare "None")) :| [])) (PosArg (Qualid (Bare "xs")) :| []))) :| [])))])),
       ...
       ("maximum"~>App (Qualid (Bare "Coq.Program.Basics.compose")) (PosArg (App (Qualid (Bare "Data.Maybe.fromMaybe")) (PosArg (Parens (App (Qualid (Bare "GHC.Base.errorWithoutStackTrace")) (PosArg (Coq.HsString "maximum: empty structure") :| []))) :| [])) :| [PosArg (App (Qualid (Bare "Coq.Program.Basics.compose")) (PosArg (Qualid (Bare "getMax")) :| [PosArg (App (Qualid (Bare "foldMap")) (PosArg (Parens (App (Qualid (Bare "hash_compose")) (PosArg (Qualid (Bare "Mk_Max")) :| [PosArg (Parens (HasType (Qualid (Bare "Some")) (Arrow (Qualid (Bare "a")) (App (Qualid (Bare "option")) (PosArg (Qualid (Bare "a")) :| [])))))]))) :| []))]))])),
       ("minimum"~>App (Qualid (Bare "Coq.Program.Basics.compose")) (PosArg (App (Qualid (Bare "Data.Maybe.fromMaybe")) (PosArg (Parens (App (Qualid (Bare "GHC.Base.errorWithoutStackTrace")) (PosArg (Coq.HsString "minimum: empty structure") :| []))) :| [])) :| [PosArg (App (Qualid (Bare "Coq.Program.Basics.compose")) (PosArg (Qualid (Bare "getMin")) :| [PosArg (App (Qualid (Bare "foldMap")) (PosArg (Parens (App (Qualid (Bare "hash_compose")) (PosArg (Qualid (Bare "Mk_Min")) :| [PosArg (Parens (HasType (Qualid (Bare "Some")) (Arrow (Qualid (Bare "a")) (App (Qualid (Bare "option")) (PosArg (Qualid (Bare "a")) :| [])))))]))) :| []))]))])),
       ...
       ("product"~>App (Qualid (Bare "hash_compose")) (PosArg (Qualid (Bare "getProduct")) :| [PosArg (App (Qualid (Bare "foldMap")) (PosArg (Qualid (Bare "Data.Monoid.Mk_Product")) :| []))])),
       ("sum"~>App (Qualid (Bare "hash_compose")) (PosArg (Qualid (Bare "getSum")) :| [PosArg (App (Qualid (Bare "foldMap")) (PosArg (Qualid (Bare "Data.Monoid.Mk_Sum")) :| []))])),
