...
{-  x <= y  = compare x y /= GT
    ...
    , "Data.Foldable.Foldable" =:
      ["elem" ~> App (Qualid (Bare "Coq.Program.Basics.compose")) (PosArg (Qualid (Bare "any")) :| [PosArg (Qualid (Bare "GHC.Base.op_zeze__"))]),
       ...
       ("foldl" ~> Fun (Inferred Explicit (Ident "arg_19__") :| [Inferred Explicit (Ident "arg_20__"),Inferred Explicit (Ident "arg_21__")]) (Coq.Match (MatchItem (Qualid (Bare "arg_19__")) Nothing Nothing :| [MatchItem (Qualid (Bare "arg_20__")) Nothing Nothing,MatchItem (Qualid (Bare "arg_21__")) Nothing Nothing]) Nothing [Equation (MultPattern (QualidPat (Bare "f") :| [QualidPat (Bare "z"),QualidPat (Bare "t")]) :| []) (App (App (Qualid (Bare "appEndo")) (PosArg (Parens (App (Qualid (Bare "Data.Monoid.getDual")) (PosArg (Parens (App (App (Qualid (Bare "foldMap")) (PosArg (Parens (App (Qualid (Bare "Coq.Program.Basics.compose")) (PosArg (Qualid (Bare "Data.Monoid.Mk_Dual")) :| [PosArg (App (Qualid (Bare "Coq.Program.Basics.compose")) (PosArg (Qualid (Bare "Data.Monoid.Endo")) :| [PosArg (App (Qualid (Bare "GHC.Base.flip")) (PosArg (Qualid (Bare "f")) :| []))]))]))) :| [])) (PosArg (Qualid (Bare "t")) :| []))) :| []))) :| [])) (PosArg (Qualid (Bare "z")) :| []))])),
       ...
       ("foldr"~>Fun (Inferred Explicit (Ident "arg_4__") :| [Inferred Explicit (Ident "arg_5__"),Inferred Explicit (Ident "arg_6__")]) (Coq.Match (MatchItem (Qualid (Bare "arg_4__")) Nothing Nothing :| [MatchItem (Qualid (Bare "arg_5__")) Nothing Nothing,MatchItem (Qualid (Bare "arg_6__")) Nothing Nothing]) Nothing [Equation (MultPattern (QualidPat (Bare "f") :| [QualidPat (Bare "z"),QualidPat (Bare "t")]) :| []) (App (App (Qualid (Bare "appEndo")) (PosArg (Parens (App (App (Qualid (Bare "foldMap")) (PosArg (Parens (App (Qualid (Bare "Data.Foldable.hash_compose")) (PosArg (Qualid (Bare "Data.Monoid.Endo")) :| [PosArg (Qualid (Bare "f"))]))) :| [])) (PosArg (Qualid (Bare "t")) :| []))) :| [])) (PosArg (Qualid (Bare "z")) :| []))])),
       ...
       ("maximum"~>App (Qualid (Bare "Coq.Program.Basics.compose")) (PosArg (App (Qualid (Bare "Data.Maybe.fromMaybe")) (PosArg (Parens (App (Qualid (Bare "GHC.Base.errorWithoutStackTrace")) (PosArg (Coq.HsString "maximum: empty structure") :| []))) :| [])) :| [PosArg (App (Qualid (Bare "Coq.Program.Basics.compose")) (PosArg (Qualid (Bare "Data.Foldable.getMax")) :| [PosArg (App (Qualid (Bare "foldMap")) (PosArg (Parens (App (Qualid (Bare "Data.Foldable.hash_compose")) (PosArg (Qualid (Bare "Data.Foldable.Mk_Max")) :| [PosArg (Parens (HasType (Qualid (Bare "Some")) (Arrow (Qualid (Bare "a")) (App (Qualid (Bare "option")) (PosArg (Qualid (Bare "a")) :| [])))))]))) :| []))]))])),
       ("minimum"~>App (Qualid (Bare "Coq.Program.Basics.compose")) (PosArg (App (Qualid (Bare "Data.Maybe.fromMaybe")) (PosArg (Parens (App (Qualid (Bare "GHC.Base.errorWithoutStackTrace")) (PosArg (Coq.HsString "minimum: empty structure") :| []))) :| [])) :| [PosArg (App (Qualid (Bare "Coq.Program.Basics.compose")) (PosArg (Qualid (Bare "Data.Foldable.getMin")) :| [PosArg (App (Qualid (Bare "foldMap")) (PosArg (Parens (App (Qualid (Bare "Data.Foldable.hash_compose")) (PosArg (Qualid (Bare "Data.Foldable.Mk_Min")) :| [PosArg (Parens (HasType (Qualid (Bare "Some")) (Arrow (Qualid (Bare "a")) (App (Qualid (Bare "option")) (PosArg (Qualid (Bare "a")) :| [])))))]))) :| []))]))])),
