...
Local Definition Functor__Either_op_zlzd__ {inst_a} : forall {a} {b},
                                                        a -> (Either inst_a) b -> (Either inst_a) a :=
...
Local Definition Applicative__Either_op_ztzg__ {inst_e} : forall {a} {b},
                                                            (Either inst_e) a -> (Either inst_e) b -> (Either inst_e)
                                                            b :=
  fun {a} {b} =>
    fun x y =>
...
Local Definition Monad__Either_op_zgzgze__ {inst_e} : forall {a} {b},
...
Program Instance Monad__Either {e} : GHC.Base.Monad (Either e) := fun _ k =>
...
Local Definition Ord__Either_compare {inst_a} {inst_b} `{GHC.Base.Ord inst_b}
                                     `{GHC.Base.Ord inst_a} : Either inst_a inst_b -> Either inst_a
                                                              inst_b -> comparison :=
  fun a b =>
    match a with
...
Local Definition Ord__Either_min {inst_a} {inst_b} `{GHC.Base.Ord inst_b}
                                 `{GHC.Base.Ord inst_a} : Either inst_a inst_b -> Either inst_a inst_b -> Either
                                                          inst_a inst_b :=
...
Local Definition Eq___Either_op_zsze__ {inst_a} {inst_b} `{_ : GHC.Base.Eq_
                                                               inst_b} `{_ : GHC.Base.Eq_ inst_a} : Either inst_a
                                                                                                           inst_b -> Either
                                                                                                    inst_a
                                                                                                    inst_b -> bool :=
