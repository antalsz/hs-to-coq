  ...
  fun arg_0__ =>
    ...
    | Decode.Lb rd rs1 oimm12 =>
        Monads.Bind (Program.getRegister rs1) (fun a =>
                       Monads.Bind (VirtualMemory.translate VirtualMemory.Load 1 (a GHC.Num.+
    ...
    | Decode.Lh rd rs1 oimm12 =>
        Monads.Bind (Program.getRegister rs1) (fun a =>
                       Monads.Bind (VirtualMemory.translate VirtualMemory.Load 2 (a GHC.Num.+
                                                             Utility.fromImm oimm12)) (fun addr =>
                                      Monads.Bind (Program.loadHalf addr) (fun x =>
                                                     Program.setRegister rd (Utility.int16ToReg x))))
    | Decode.Lw rd rs1 oimm12 =>
        Monads.Bind (Program.getRegister rs1) (fun a =>
                       Monads.Bind (VirtualMemory.translate VirtualMemory.Load 4 (a GHC.Num.+
                                                             Utility.fromImm oimm12)) (fun addr =>
    ...
    | Decode.Sb rs1 rs2 simm12 =>
        Monads.Bind (Program.getRegister rs1) (fun a =>
                       Monads.Bind (VirtualMemory.translate VirtualMemory.Store 1 (a GHC.Num.+
    ...
    | Decode.Sh rs1 rs2 simm12 =>
        Monads.Bind (Program.getRegister rs1) (fun a =>
                       Monads.Bind (VirtualMemory.translate VirtualMemory.Store 2 (a GHC.Num.+
                                                             Utility.fromImm simm12)) (fun addr =>
                                      Monads.Bind (Program.getRegister rs2) (fun x =>
                                                     Program.storeHalf addr (Utility.regToInt16 x))))
    | Decode.Sw rs1 rs2 simm12 =>
        Monads.Bind (Program.getRegister rs1) (fun a =>
                       Monads.Bind (VirtualMemory.translate VirtualMemory.Store 4 (a GHC.Num.+
                                                             Utility.fromImm simm12)) (fun addr =>
                                      Monads.Bind (Program.getRegister rs2) (fun x =>
...
(* Unbound variables:
     bool negb unit Coq.ZArith.BinInt.Z.eqb Coq.ZArith.BinInt.Z.lor
     ...
     GHC.Base.when GHC.Err.error GHC.Num.op_zm__ GHC.Num.op_zp__ GHC.Real.mod_
     Monads.Bind Program.RiscvProgram Program.getPC Program.getRegister
     ...
     Program.storeWord Utility.fromImm Utility.int16ToReg Utility.int32ToReg
     Utility.int8ToReg Utility.ltu Utility.regToInt16 Utility.regToInt32
     Utility.regToInt8 Utility.regToShamt Utility.sll Utility.sra Utility.srl
     Utility.uInt16ToReg Utility.uInt8ToReg VirtualMemory.Load VirtualMemory.Store
