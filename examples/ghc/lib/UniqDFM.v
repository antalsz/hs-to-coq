...
Inductive TaggedVal val : Type
  := Mk_TaggedVal : val -> BinNums.N -> TaggedVal val.

Inductive UniqDFM ele : Type
  := UDFM
   : (Data.IntMap.Internal.IntMap (TaggedVal ele)) -> BinNums.N -> UniqDFM ele.
...
Definition sizeUDFM {elt} : UniqDFM elt -> BinNums.N :=
  fun '(UDFM m _i) => Data.IntMap.Internal.size m.
...
Definition taggedSnd {val} : TaggedVal val -> BinNums.N :=
...
(* External variables:
     ...
     BinNums.N Coq.Lists.List.flat_map Data.Foldable.foldl Data.Foldable.foldr
     ...
     GHC.Base.op_zsze____ GHC.Num.fromInteger GHC.Num.op_zp__ UniqFM.UniqFM
