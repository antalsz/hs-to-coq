...
Definition branchMask : Prefix -> Prefix -> Mask :=
  fun p1 p2 =>
    IntWord.intFromWord (IntWord.highestBitMask (Data.Bits.xor (IntWord.wordFromInt
                                                                p1) (IntWord.wordFromInt p2))).
...
Definition maskW : Nat -> Nat -> Prefix :=
  fun i m =>
    IntWord.intFromWord (i Data.Bits..&.(**)
                         (Data.Bits.xor (Data.Bits.complement (m GHC.Num.- #1)) m)).

Definition mask : IntWord.Int -> Mask -> Prefix :=
  fun i m => maskW (IntWord.wordFromInt i) (IntWord.wordFromInt m).
...
Definition shorter : Mask -> Mask -> bool :=
  fun m1 m2 => (IntWord.wordFromInt m1) GHC.Base.> (IntWord.wordFromInt m2).
...
Definition zero : IntWord.Int -> Mask -> bool :=
  fun i m =>
    ((IntWord.wordFromInt i) Data.Bits..&.(**) (IntWord.wordFromInt m)) GHC.Base.==
    #0.
