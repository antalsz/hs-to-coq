{-# LANGUAGE BangPatterns, ExistentialQuantification, CPP, MagicHash, RankNTypes #-}
...
instance P.Num Size where
    (+) = addSize
    (-) = subtractSize
    (*) = mulSize

    fromInteger = f where f = exactSize . P.fromInteger
                          {-# INLINE f #-}
...
overflowError :: Int
overflowError = P.error "Data.Text.Internal.Fusion.Size: size overflow"
