  ...
  fun arg_0__ arg_1__ arg_2__ arg_3__ arg_4__ =>
    ...
    | exi , new , UFM m , k , v =>
        UFM (Data.IntMap.Internal.insertWith (fun _new old => exi v old) (Unique.getKey
                                                                         GHC.Base.$ Unique.getUnique k) (new v) m)
    end.
...
Definition keysUFM {elt} : UniqFM elt -> list Unique.Unique :=
  fun arg_0__ =>
    ...
    GHC.Base.map Unique.getUnique GHC.Base.$ Data.IntMap.Internal.keys m.
...
Definition plusUFM_CD {elt} : (elt -> elt -> elt) -> UniqFM elt -> elt -> UniqFM
  ...
  fun arg_0__ arg_1__ arg_2__ arg_3__ arg_4__ =>
    ...
    | f , UFM xm , dx , UFM ym , dy =>
        UFM GHC.Base.$ Data.IntMap.Internal.mergeWithKey (fun arg_5__ arg_6__ arg_7__ =>
...
Definition ufmToList {elt} : UniqFM elt -> list (Unique.Unique * elt)%type :=
  fun arg_0__ =>
    ...
    GHC.Base.map (fun arg_1__ =>
                   ...
                   pair (Unique.getUnique k) v) GHC.Base.$ Data.IntMap.Internal.toList m.
