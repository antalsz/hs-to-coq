...
Inductive Compose (f : Type -> Type) (g : Type -> Type) (a : Type) : Type
  := Mk_Compose : f (g a) -> Compose f g a.
...
(* Skipping instance Read1__Compose of class Read1 *)

(* Skipping instance Show1__Compose of class Show1 *)
...
(* Skipping instance Read__Compose of class Read *)

(* Skipping instance Show__Compose of class Show *)
...
(* Skipping instance Alternative__Compose of class Alternative *)

(* Skipping instance Generic1__Compose__5 of class Generic1 *)

(* Skipping instance Generic__Compose of class Generic *)

(* Skipping instance Data__Compose of class Data *)
