...
Definition lookupGE {k} {v} `{GHC.Base.Ord k} : k -> Map k v -> option (k *
                                                                       v)%type :=
  let goJust :=
    fix goJust arg_0__ arg_1__ arg_2__ arg_3__
          := let j_11__ :=
  ...
  let goNothing :=
    fix goNothing arg_14__ arg_15__
          := let j_22__ :=
               match arg_14__ , arg_15__ with
                 | _ , Tip => None
                 | k , Bin _ kx x l r => let scrut_16__ := GHC.Base.compare k kx in
...
Definition lookupGT {k} {v} `{GHC.Base.Ord k} : k -> Map k v -> option (k *
  ...
  let goJust :=
    fix goJust arg_0__ arg_1__ arg_2__ arg_3__
          := let j_7__ :=
               match arg_0__ , arg_1__ , arg_2__ , arg_3__ with
                 | _ , kx' , x' , Tip => Some (pair kx' x')
                 | k , kx' , x' , Bin _ kx x l r => let j_5__ := goJust k kx' x' r in
  ...
  let goNothing :=
    fix goNothing arg_10__ arg_11__
          := let j_14__ :=
               match arg_10__ , arg_11__ with
                 | _ , Tip => None
                 | k , Bin _ kx x l r => let j_12__ := goNothing k r in
                                         if k GHC.Base.< kx : bool
                                         then goJust k kx x l
                                         else j_12__
               end in
  ...
  let goNothing :=
    fix goNothing arg_10__ arg_11__
          := let j_14__ :=
               match arg_10__ , arg_11__ with
                 | _ , Tip => None
                 | k , Bin _ kx x l r => let j_12__ := goJust k kx x r in
                                         if k GHC.Base.<= kx : bool
                                         then goNothing k l
                                         else j_12__
               end in
  ...
  fun arg_0__ =>
    match arg_0__ with
      ...
      | cons (pair kx0 x0) xs0 => let create :=
                                                                                   ...
                                                                                   match scrut_4__ with
                                                                                     ...
                                                                                     | pair l (cons (pair ky y) ys) =>
                                                                                       let scrut_5__ :=
                                                                                         ...
                                                                                         ys in
                                                                                       match scrut_5__ with
                                                                                         | pair r zs => pair (link ky y
                                                                                                             l r) zs
                                                                                       end
                                                                                   end in
                                                                                 if s GHC.Base.== GHC.Num.fromInteger
                                                                                    1 : bool
                                                                                 then match x' with
                                                                                        | pair kx x => pair (Bin
                                                                                                            (GHC.Num.fromInteger
                                  ...
                                  let go :=
                                    unsafeFix (fun go arg_17__ arg_18__ arg_19__ =>
                                                let j_24__ :=
                                                  match arg_17__ , arg_18__ , arg_19__ with
                                                    | _ , t , nil => t
                                                    | s , l , cons (pair kx x) xs => let scrut_20__ := create s xs in
                                                                                     match scrut_20__ with
                                                                                       | pair r ys => go
                                                                                                      (Data.Bits.shiftL
                                                                                                      s
                                                                                                      (GHC.Num.fromInteger
  ...
  fun f xs =>
    let combineEq' :=
      unsafeFix (fun combineEq' arg_0__ arg_1__ =>
                  match arg_0__ , arg_1__ with
                    | z , nil => cons z nil
                    | (pair kz zz as z) , cons (pair kx xx as x) xs' => let j_3__ :=
                                                                          cons z (combineEq' x xs') in
  ...
  fun arg_0__ =>
    match arg_0__ with
      ...
      | cons (pair kx0 x0) xs0 => let fromList' :=
                                    ...
                                    unsafeFix (fun create arg_11__ arg_12__ =>
                                                let j_27__ :=
                                                  match arg_11__ , arg_12__ with
                                                    ...
                                                    | s , (cons xp xss as xs) => let j_22__ :=
                                                                                   let scrut_14__ :=
                                                                                     create (Data.Bits.shiftR s
                                                                                                              (GHC.Num.fromInteger
                                                                                                              1)) xs in
                                  ...
                                  let go :=
                                    unsafeFix (fun go arg_30__ arg_31__ arg_32__ =>
                                                let j_40__ :=
                                                  match arg_30__ , arg_31__ , arg_32__ with
                                                    | _ , t , nil => t
                                                    | _ , t , cons (pair kx x) nil => insertMax kx x t
                                                    | s , l , (cons (pair kx x) xss as xs) => let j_38__ :=
                                                                                                let scrut_34__ :=
                                                                                                  create s xss in
                                                                                                match scrut_34__ with
                                                                                                  | pair (pair r ys)
                                                                                                         nil => go
                                                                                                                (Data.Bits.shiftL
                                                                                                                s
                                ...
                                | Tip => let scrut_8__ := pair ll lr in
                                         match scrut_8__ with
                                           ...
                                           | pair (Bin _ _ _ _ _) Tip => Bin (GHC.Num.fromInteger 3) lk lx ll (Bin
                                                                                                              ...
                                                                                                              1) k x Tip
                                                                                                              Tip)
                                           | pair (Bin lls _ _ _ _) (Bin lrs lrk lrx lrl lrr) => let j_12__ :=
                                                                                                   Bin
                                                                                                   (GHC.Num.fromInteger
                                                                                                   1 GHC.Num.+ ls) lrk
                                                                                                   lrx (Bin
      ...
      fix go arg_0__
            := let j_3__ :=
               ...
               match arg_0__ with
                 ...
                 | Bin num_1__ k v _ _ => if num_1__ GHC.Base.== GHC.Num.fromInteger 1 : bool
                                          then (fun v' => Bin (GHC.Num.fromInteger 1) k v' Tip Tip) Data.Functor.<$> f k
                                               v
                                          else j_3__
               end in
    go.
...
Definition mergeWithKey {k} {a} {b} {c} `{GHC.Base.Ord k}
  ...
  fun f g1 g2 =>
    let hedgeMerge :=
      fix hedgeMerge arg_0__ arg_1__ arg_2__ arg_3__
            := match arg_0__ , arg_1__ , arg_2__ , arg_3__ with
                 | _ , _ , t1 , Tip => g1 t1
...
(* Unbound variables:
     ...
     GHC.Base.op_zsze__ GHC.Base.pure GHC.Err.error GHC.Err.undefined GHC.Num.Int
     GHC.Num.Num GHC.Num.op_zm__ GHC.Num.op_zp__ GHC.Num.op_zt__ GHC.Prim.seq Nat.add
*)
