...
Axiom member_lookup :
   forall (A : Type)
     (key : Internal.Key) 
     (i : IntMap.IntMap A),
   (is_true (IntMap.member key i)) =
   (exists val, IntMap.lookup key i = Some val).
...
Axiom filter_comp : forall A f f' (i : IntMap.IntMap A),
...
Axiom filter_true : forall (A:Type) (m:IntMap.IntMap A), 
