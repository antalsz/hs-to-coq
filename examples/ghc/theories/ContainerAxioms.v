...
Section FMapInterface. 

Variable A : Type.
Variable eqA : `{Eq_ A}.
Variable eqlA : `{EqLaws A}.
Variable e e' : A.
Variable x y : Internal.Key.
Variable m   : Internal.IntMap A.

Parameter MapsTo_1 : (x == y) -> Internal.lookup x m = Some e -> Internal.lookup y m = Some e.

Parameter mem_1 : (exists e, Internal.lookup x m = Some e) -> Internal.member x m = true.
Parameter mem_2 : Internal.member x m = true -> exists e, Internal.lookup x m = Some e.

Parameter empty_1 : Internal.member x (Internal.empty : Internal.IntMap A) <> true.

Parameter is_empty_1 : (forall x, Internal.member x m <> true) -> Internal.null m = true.
Parameter is_empty_2 : Internal.null m = true -> Internal.member x m <> true.

Parameter add_1 : x == y -> Internal.lookup y (Internal.insert x e m) = Some e.
Parameter add_2 : (x <> y) -> Internal.lookup y m = Some e -> Internal.lookup y (Internal.insert x e' m) = Some e.
Parameter add_3 : (x <> y) -> Internal.lookup y (Internal.insert x e' m) = Some e -> Internal.lookup y m = Some e.

Parameter remove_1 : x == y -> ~ (exists e, Internal.lookup y (Internal.delete x m) = Some e).
Parameter remove_2 : (x <> y) -> Internal.lookup y m = Some e -> Internal.lookup y (Internal.delete x m) = Some e.
Parameter remove_3 : Internal.lookup y (Internal.delete x m) = Some e -> Internal.lookup y m = Some e.
