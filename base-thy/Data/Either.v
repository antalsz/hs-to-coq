...
Proof.
  split ;
    ...
    instance_forall___GHC_Base_Eq__b____GHC_Base_Eq__a___GHC_Base_Eq___Data_Either_Either_a_b_ ,  op_zeze____, op_zsze____=> - [xl|xr] [yl|yr] //=; try (by constructor);
...
Proof.
  split; repeat unfold fmap, instance_GHC_Base_Functor__Data_Either_Either_a_,
         Either.instance_GHC_Base_Functor__Data_Either_Either_a__fmap.
...
Proof.
  split;
    ...
    Either.instance_GHC_Base_Applicative__Data_Either_Either_e__pure,
    Either.instance_GHC_Base_Applicative__Data_Either_Either_e__op_zlztzg__,
    Either.instance_GHC_Base_Functor__Data_Either_Either_a__fmap; simpl).
...
Proof.
  split; intros;
   repeat (unfold pure, instance_Applicative__Data_Either_Either_a_,
    ...
    Either.instance_GHC_Base_Applicative__Data_Either_Either_e__op_zlztzg__,
    Either.instance_GHC_Base_Functor__Data_Either_Either_a__fmap,
    Either.instance_GHC_Base_Monad__Data_Either_Either_e__return_,
    instance_GHC_Base_Monad__Data_Either_Either_e__op_zgzgze__; simpl).
  - auto.
  - destruct m; auto.
